...
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID =
  'https://oridesign.local/schemas/m0f/neg-path-angle-knot-cardinality-candidate-bundle-ledger-v1.schema.json' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE =
  'm0f-neg-path-angle-knot-cardinality-candidate-bundle-ledger' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCOPE =
  'project-authored-exact-negative-artifact-contract-bounded-interpolation-angle-knot-cardinality-parser-replay-only' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_ID =
  'oridesign-neg-path-angle-knot-cardinality-candidate-bundle' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_VERSION =
  '1.0.0-candidate' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY =
  'tests/candidate-vectors/NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME =
  'candidate-bundle-ledger.json' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANONICAL_MANIFEST_PATH =
  'tests/fixtures/manifest.json' as const;
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_ID =
  'NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH' as const;

const SOURCE_REFERENCE_ID = 'oridesign-neg-path-angle-knot-cardinality-candidate-v1' as const;
const CONTROL_ARTIFACT_ID = 'control-fold' as const;
const SOURCE_ARTIFACT_ID = 'source-path-angle-knot-cardinality' as const;
const SHA256_PATTERN = /^sha256:[0-9a-f]{64}$/;

export type NegPathAngleKnotCardinalitySourceDocumentV1 = NegPathAngleBoundSourceDocumentV1;

export const NEG_PATH_ANGLE_KNOT_CARDINALITY_FOLD_CONTROL_SOURCE_V1 = deepFreezeOwned(
  structuredClone(NEG_PATH_ANGLE_BOUND_FOLD_CONTROL_SOURCE_V1),
);

function angleKnotCardinalitySource(): NegPathAngleKnotCardinalitySourceDocumentV1 {
  const source = structuredClone(NEG_PATH_ANGLE_KNOT_CARDINALITY_FOLD_CONTROL_SOURCE_V1);
  ...
  if (firstAngles === undefined) throw new TypeError('fixed first angle row is missing');
  const removed = firstAngles.angles.splice(2, 1);
  if (removed[0] !== Math.PI) throw new TypeError('fixed terminal angle must equal pi');
  return source;
}

type ExpectedIssueV1 = Readonly<{ path: string; code: string }>;

export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1 = deepFreezeOwned({
  caseId: NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_ID,
  controlArtifactId: CONTROL_ARTIFACT_ID,
  mutationKind: 'delete-terminal-angle-from-three-knot-bounded-interpolation-row',
  changedPaths: ['$.pathCandidate.segments[0].motion.anglesByCrease[0].angles[2]'],
  sourceArtifactId: SOURCE_ARTIFACT_ID,
  sourcePath: 'path-angle-knot-cardinality-mismatch.json',
  sourceDocument: angleKnotCardinalitySource(),
  expectedIssues: [
    {
...
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_README_V1 = `# NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH exact-negative candidate vector
...
export type NegPathAngleKnotCardinalityArtifactProvenanceV1 = Readonly<{
...
export type NegPathAngleKnotCardinalityArtifactLedgerEntryV1 = Readonly<{
  artifactId: string;
  ...
  licenseSpdx: 'MIT';
  provenance: NegPathAngleKnotCardinalityArtifactProvenanceV1;
}>;

function artifactProvenance(
  dependsOnArtifactIds: readonly (typeof CONTROL_ARTIFACT_ID)[],
): NegPathAngleKnotCardinalityArtifactProvenanceV1 {
  return {
...
type ArtifactSpecV1 = Omit<NegPathAngleKnotCardinalityArtifactLedgerEntryV1, 'sha256'>;

export const NEG_PATH_ANGLE_KNOT_CARDINALITY_ARTIFACT_SPECS_V1 = deepFreezeOwned([
  {
  ...
  },
  {
    ...
    path: NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.sourcePath,
    mediaType: 'application/json',
    licenseSpdx: 'MIT',
...
export type NegPathAngleKnotCardinalityCaseLedgerRowV1 = Readonly<{
  caseIndex: 0;
  caseId: typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_ID;
  controlArtifactId: typeof CONTROL_ARTIFACT_ID;
  mutationKind: typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.mutationKind;
  changedPaths: readonly ['$.pathCandidate.segments[0].motion.anglesByCrease[0].angles[2]'];
...
const GENERATOR = deepFreezeOwned({
  generatorId: NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_ID,
  generatorVersion: NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_VERSION,
...
const SOURCE_PROVENANCE = deepFreezeOwned({
  ...
  title:
    'NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH project-authored bounded-interpolation angle/knot cardinality parser vector',
  authors: ['OriDesign contributors'],
  redistribution: 'allowed' as const,
  licenseSpdx: 'MIT' as const,
});

function ledgerCases(): readonly NegPathAngleKnotCardinalityCaseLedgerRowV1[] {
  return [
    {
      caseIndex: 0,
      caseId: NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_ID,
      controlArtifactId: CONTROL_ARTIFACT_ID,
      mutationKind: NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.mutationKind,
      changedPaths: NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.changedPaths,
      sourceArtifactId: SOURCE_ARTIFACT_ID,
      sourcePath: NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.sourcePath,
      expectedOutcome: 'rejected',
      expectedIssues: NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.expectedIssues,
    },
  ];
}

export type NegPathAngleKnotCardinalityCandidateBundleLedgerV1 = Readonly<{
  schemaVersion: 1;
  schemaId: typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID;
  recordType: typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE;
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH-V1';
  scope: typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCOPE;
  declaredBoundedInterpolationAngleKnotCardinalityParserOnly: true;
  canonicalManifestPath: typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CANONICAL_MANIFEST_PATH;
  ...
  cases: readonly NegPathAngleKnotCardinalityCaseLedgerRowV1[];
  artifacts: readonly NegPathAngleKnotCardinalityArtifactLedgerEntryV1[];
}>;

export type NegPathAngleKnotCardinalityCandidateLedgerIssueV1 = Readonly<{
  path: string;
  code:
    | 'invalid-snapshot'
    | 'invalid-object'
...
export type NegPathAngleKnotCardinalityCandidateLedgerParseResultV1 =
  | Readonly<{ ok: true; value: NegPathAngleKnotCardinalityCandidateBundleLedgerV1 }>
  | Readonly<{ ok: false; error: readonly NegPathAngleKnotCardinalityCandidateLedgerIssueV1[] }>;
...
const FIXED_LITERALS = [
  ['schemaVersion', 1],
  ['schemaId', NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID],
  ['recordType', NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE],
  ['contractStatus', 'candidate'],
  ['scientificClaim', false],
  ['vectorSetId', 'NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH-V1'],
  ['scope', NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCOPE],
  ['declaredBoundedInterpolationAngleKnotCardinalityParserOnly', true],
  ['canonicalManifestPath', NEG_PATH_ANGLE_KNOT_CARDINALITY_CANONICAL_MANIFEST_PATH],
  ['canonicalManifestRegistration', 'not-registered'],
  ['canonicalPromotionClaimed', false],
  ['canonicalPathMutationFamilyComplete', false],
  ['boundKnotIntervalCardinalityEstablished', false],
...
function addLedgerIssue(
  issues: NegPathAngleKnotCardinalityCandidateLedgerIssueV1[],
  path: string,
  code: NegPathAngleKnotCardinalityCandidateLedgerIssueV1['code'],
  message: string,
): void {
...
export function parseNegPathAngleKnotCardinalityCandidateBundleLedgerV1(
  supplied: unknown,
): NegPathAngleKnotCardinalityCandidateLedgerParseResultV1 {
  ...
  const issues: NegPathAngleKnotCardinalityCandidateLedgerIssueV1[] = [];
  ...
  if (!Array.isArray(value.artifacts) || value.artifacts.length !== 3) {
    ...
    for (const [index, expected] of NEG_PATH_ANGLE_KNOT_CARDINALITY_ARTIFACT_SPECS_V1.entries()) {
  ...
  return deepFreezeOwned({
    ok: true as const,
    value: value as unknown as NegPathAngleKnotCardinalityCandidateBundleLedgerV1,
  });
}
...
export function angleKnotCardinalityJsonDifferencePaths(
  left: unknown,
  right: unknown,
  path = '$',
): string[] {
  ...
  if (Array.isArray(left) && Array.isArray(right)) {
    ...
    for (let index = 0; index < Math.max(left.length, right.length); index += 1) {
      ...
      if (!Object.hasOwn(left, index) || !Object.hasOwn(right, index)) differences.push(childPath);
        ...
        differences.push(
          ...angleKnotCardinalityJsonDifferencePaths(left[index], right[index], childPath),
        );
    }
    return differences;
  }
  if (isRecord(left) && isRecord(right)) {
    ...
    for (const key of keys) {
      ...
      if (!Object.hasOwn(left, key) || !Object.hasOwn(right, key)) differences.push(childPath);
        ...
        differences.push(
          ...angleKnotCardinalityJsonDifferencePaths(left[key], right[key], childPath),
        );
    }
    return differences;
  }
...
export type NegPathAngleKnotCardinalityCandidateBuiltFileV1 = Readonly<{
  artifactId: string | null;
  path: string;
  text: string;
}>;

export type NegPathAngleKnotCardinalityCandidateBuildV1 = Readonly<{
  ledger: NegPathAngleKnotCardinalityCandidateBundleLedgerV1;
  files: readonly NegPathAngleKnotCardinalityCandidateBuiltFileV1[];
}>;

export function buildNegPathAngleKnotCardinalityCandidateBundleV1(): NegPathAngleKnotCardinalityCandidateBuildV1 {
  if (!parseArtifactContractV1(NEG_PATH_ANGLE_KNOT_CARDINALITY_FOLD_CONTROL_SOURCE_V1).ok) {
    throw new TypeError('accepted angle/knot cardinality control no longer parses');
  }
  const differences = angleKnotCardinalityJsonDifferencePaths(
    NEG_PATH_ANGLE_KNOT_CARDINALITY_FOLD_CONTROL_SOURCE_V1,
    NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.sourceDocument,
  );
  if (!sameStableJson(differences, NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.changedPaths)) {
    throw new TypeError('angle/knot cardinality control deletion delta changed');
  }
  ...
  if (
    ...
    throw new TypeError('angle/knot cardinality parser oracle changed');
  }
  const textByArtifactId = new Map<string, string>([
    ['bundle-readme', NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_README_V1],
    [CONTROL_ARTIFACT_ID, jsonLine(NEG_PATH_ANGLE_KNOT_CARDINALITY_FOLD_CONTROL_SOURCE_V1)],
    [SOURCE_ARTIFACT_ID, jsonLine(NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.sourceDocument)],
  ]);
  const artifacts = NEG_PATH_ANGLE_KNOT_CARDINALITY_ARTIFACT_SPECS_V1.map((spec) => {
    const text = textByArtifactId.get(spec.artifactId);
    if (text === undefined)
      throw new TypeError(`missing angle/knot cardinality artifact ${spec.artifactId}`);
    return { ...spec, sha256: sha256Prefixed(text) as `sha256:${string}` };
  });
  const ledger: NegPathAngleKnotCardinalityCandidateBundleLedgerV1 = {
    schemaVersion: 1,
    schemaId: NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID,
    recordType: NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE,
    contractStatus: 'candidate',
  ...
  const files: NegPathAngleKnotCardinalityCandidateBuiltFileV1[] = artifacts.map((artifact) => {
    const text = textByArtifactId.get(artifact.artifactId);
    if (text === undefined)
      throw new TypeError(`missing angle/knot cardinality artifact ${artifact.artifactId}`);
    return { artifactId: artifact.artifactId, path: artifact.path, text };
  });
  files.push({
    artifactId: null,
    path: NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    text: jsonLine(ledger),
  });
  return deepFreezeOwned({ ledger, files });
}

export async function writeNegPathAngleKnotCardinalityCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathAngleKnotCardinalityCandidateBuildV1> {
  const built = buildNegPathAngleKnotCardinalityCandidateBundleV1();
  ...
  if (existing.some((entry) => !entry.isFile() || !expectedNames.has(entry.name))) {
    throw new TypeError(
      'negative path angle/knot cardinality candidate directory contains an unexpected entry',
    );
  }
  await Promise.all(
...
export const NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_REASON_CODES = [
  'ledger-unreadable',
  'ledger-invalid',
...
export type NegPathAngleKnotCardinalityCandidateReasonCodeV1 =
  (typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_REASON_CODES)[number];
...
export type NegPathAngleKnotCardinalityCandidateVerificationResultV1 = Readonly<{
  schemaVersion: 1;
  recordType: 'm0f-neg-path-angle-knot-cardinality-candidate-bundle-verification-result';
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH-V1';
  scope: typeof NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCOPE;
  ...
  reasonCodes: readonly NegPathAngleKnotCardinalityCandidateReasonCodeV1[];
  checks: VerificationChecks;
}>;

interface MutableVerificationState {
  reasons: Set<NegPathAngleKnotCardinalityCandidateReasonCodeV1>;
...
): NegPathAngleKnotCardinalityCandidateVerificationResultV1 {
  const reasonCodes = NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_REASON_CODES.filter((code) =>
    state.reasons.has(code),
  );
  return deepFreezeOwned({
    schemaVersion: 1 as const,
    recordType: 'm0f-neg-path-angle-knot-cardinality-candidate-bundle-verification-result' as const,
    contractStatus: 'candidate' as const,
    scientificClaim: false as const,
    vectorSetId: 'NEG-PATH-MUTATION-ANGLE-KNOT-CARDINALITY-MISMATCH-V1' as const,
    scope: NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_SCOPE,
    declaredBoundedInterpolationAngleKnotCardinalityParserOnly: true as const,
...
async function canonicalCaseIsAbsent(): Promise<boolean | undefined> {
  try {
    const parsed = parseFixtureManifest(
      JSON.parse(
        await readFile(resolve(NEG_PATH_ANGLE_KNOT_CARDINALITY_CANONICAL_MANIFEST_PATH), 'utf8'),
      ) as unknown,
    );
    if (parsed.manifest === undefined) return undefined;
    return !parsed.manifest.fixtures.some(
      (fixture) => fixture.id === NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_ID,
    );
  } catch {
    return undefined;
  }
...
export async function verifyNegPathAngleKnotCardinalityCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathAngleKnotCardinalityCandidateVerificationResultV1> {
  ...
  try {
    ...
    const parsedLedger = parseNegPathAngleKnotCardinalityCandidateBundleLedgerV1(ledgerDocument);
    if (!parsedLedger.ok) {
    ...
    const textByPath = new Map<string, string>([
      [NEG_PATH_ANGLE_KNOT_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME, ledgerText],
    ]);
    ...
    if (source === undefined) {
      ...
      if (
        control !== undefined &&
        sameStableJson(
          angleKnotCardinalityJsonDifferencePaths(control, source),
          NEG_PATH_ANGLE_KNOT_CARDINALITY_CASE_SPEC_V1.changedPaths,
        )
      ) {
    ...
    const regenerated = buildNegPathAngleKnotCardinalityCandidateBundleV1();
