...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID =
  'https://oridesign.local/schemas/m0f/neg-path-bounded-interval-angle-bound-tuple-cardinality-candidate-bundle-ledger-v1.schema.json' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE =
  'm0f-neg-path-bounded-interval-angle-bound-tuple-cardinality-candidate-bundle-ledger' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCOPE =
  'project-authored-exact-negative-artifact-contract-bounded-interpolation-interval-angle-bound-tuple-cardinality-parser-replay-only' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_ID =
  'oridesign-neg-path-bounded-interval-angle-bound-tuple-cardinality-candidate-bundle' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_VERSION =
  '1.0.0-candidate' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY =
  'tests/candidate-vectors/NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME =
  'candidate-bundle-ledger.json' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANONICAL_MANIFEST_PATH =
  'tests/fixtures/manifest.json' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_ID =
  'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH' as const;

const SOURCE_REFERENCE_ID =
  'oridesign-neg-path-bounded-interval-angle-bound-tuple-cardinality-candidate-v1' as const;
const CONTROL_ARTIFACT_ID = 'control-fold' as const;
const SOURCE_ARTIFACT_ID = 'source-path-bounded-interval-angle-bound-tuple-cardinality' as const;
const SHA256_PATTERN = /^sha256:[0-9a-f]{64}$/;

export type NegPathBoundedIntervalAngleBoundTupleCardinalitySourceDocumentV1 =
  NegPathAngleBoundSourceDocumentV1;

function ownedAcceptedControl(): NegPathBoundedIntervalAngleBoundTupleCardinalitySourceDocumentV1 {
...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_FOLD_CONTROL_SOURCE_V1 =
  deepFreezeOwned(ownedAcceptedControl());

function boundedIntervalAngleBoundTupleCardinalitySource(): NegPathBoundedIntervalAngleBoundTupleCardinalitySourceDocumentV1 {
  const source = structuredClone(
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_FOLD_CONTROL_SOURCE_V1,
  );
  ...
  if (
    ...
    throw new TypeError(
      'fixed bounded-interpolation interval-angle-bound anchor drifted before tuple extension',
    );
  }
  (bounds[0] as unknown[]).push(Math.PI);
  return source;
}

type ExpectedIssueV1 = Readonly<{ path: string; code: string }>;

export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1 = deepFreezeOwned(
  {
    caseId: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_ID,
    controlArtifactId: CONTROL_ARTIFACT_ID,
    mutationKind: 'append-third-coordinate-to-first-bounded-interpolation-interval-angle-bound',
    changedPaths: [
      '$.pathCandidate.segments[0].motion.intervalAngleBoundsByCrease[0].bounds[0][2]',
    ],

    sourceArtifactId: SOURCE_ARTIFACT_ID,
    sourcePath: 'path-bounded-interval-angle-bound-tuple-cardinality-mismatch.json',
    sourceDocument: boundedIntervalAngleBoundTupleCardinalitySource(),
    expectedIssues: [
      {
...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_README_V1 = `# NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH exact-negative candidate vector
...
export type NegPathBoundedIntervalAngleBoundTupleCardinalityArtifactProvenanceV1 = Readonly<{
...
export type NegPathBoundedIntervalAngleBoundTupleCardinalityArtifactLedgerEntryV1 = Readonly<{
  artifactId: string;
  ...
  licenseSpdx: 'MIT';
  provenance: NegPathBoundedIntervalAngleBoundTupleCardinalityArtifactProvenanceV1;
}>;

function artifactProvenance(
  dependsOnArtifactIds: readonly (typeof CONTROL_ARTIFACT_ID)[],
): NegPathBoundedIntervalAngleBoundTupleCardinalityArtifactProvenanceV1 {
  return {
...
type ArtifactSpecV1 = Omit<
  NegPathBoundedIntervalAngleBoundTupleCardinalityArtifactLedgerEntryV1,
  'sha256'
>;

export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_ARTIFACT_SPECS_V1 =
  deepFreezeOwned([
    {
    ...
    },
    {
      ...
      path: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.sourcePath,
      mediaType: 'application/json',
      licenseSpdx: 'MIT',
...
export type NegPathBoundedIntervalAngleBoundTupleCardinalityCaseLedgerRowV1 = Readonly<{
  caseIndex: 0;
  caseId: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_ID;
  controlArtifactId: typeof CONTROL_ARTIFACT_ID;
  mutationKind: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.mutationKind;
...
const GENERATOR = deepFreezeOwned({
  generatorId:
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_ID,
  generatorVersion:
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_VERSION,
...
const SOURCE_PROVENANCE = deepFreezeOwned({
  ...
  title:
    'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH project-authored bounded-interpolation interval-angle-bound tuple-cardinality parser vector',
  authors: ['OriDesign contributors'],
  redistribution: 'allowed' as const,
  licenseSpdx: 'MIT' as const,
});

function ledgerCases(): readonly NegPathBoundedIntervalAngleBoundTupleCardinalityCaseLedgerRowV1[] {
  return [
    {
      caseIndex: 0,
      caseId: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_ID,
      controlArtifactId: CONTROL_ARTIFACT_ID,
      mutationKind:
        NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.mutationKind,
      changedPaths:
        NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.changedPaths,
      sourceArtifactId: SOURCE_ARTIFACT_ID,
      sourcePath: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.sourcePath,
      expectedOutcome: 'rejected',
      expectedIssues:
        NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.expectedIssues,
    },
  ];
}

export type NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleLedgerV1 = Readonly<{
  schemaVersion: 1;
  schemaId: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID;
  recordType: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE;
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH-V1';
  scope: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCOPE;
  declaredBoundedInterpolationIntervalAngleBoundTupleCardinalityParserOnly: true;
  ...
  canonicalManifestPath: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANONICAL_MANIFEST_PATH;
  ...
  cases: readonly NegPathBoundedIntervalAngleBoundTupleCardinalityCaseLedgerRowV1[];
  artifacts: readonly NegPathBoundedIntervalAngleBoundTupleCardinalityArtifactLedgerEntryV1[];
}>;

export type NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateLedgerIssueV1 = Readonly<{
  path: string;
  code:
    | 'invalid-snapshot'
    | 'invalid-object'
...
export type NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateLedgerParseResultV1 =
  | Readonly<{
      ok: true;
      value: NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleLedgerV1;
    }>
  | Readonly<{
      ok: false;
      error: readonly NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateLedgerIssueV1[];
    }>;
const ROOT_KEYS = [
  'schemaVersion',
  'schemaId',
...
const FIXED_LITERALS = [
  ['schemaVersion', 1],
  ['schemaId', NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID],
  [
    'recordType',
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE,
  ],
  ['contractStatus', 'candidate'],
  ['scientificClaim', false],
  ['vectorSetId', 'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH-V1'],
  ['scope', NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCOPE],
  ['declaredBoundedInterpolationIntervalAngleBoundTupleCardinalityParserOnly', true],
  ['declaredBoundedInterpolationFiniteIntervalAngleBoundsParserOnly', false],
  ['declaredBoundedInterpolationFiniteAnglesParserOnly', false],
  ['declaredBoundedInterpolationFiniteKnotTimesParserOnly', false],
  ...
  [
    'canonicalManifestPath',
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANONICAL_MANIFEST_PATH,
  ],
  ['canonicalManifestRegistration', 'not-registered'],
  ['canonicalPromotionClaimed', false],
  ['canonicalPathMutationFamilyComplete', false],
...
function addLedgerIssue(
  issues: NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateLedgerIssueV1[],
  path: string,
  code: NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateLedgerIssueV1['code'],
  message: string,
): void {
...
export function parseNegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleLedgerV1(
  supplied: unknown,
): NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateLedgerParseResultV1 {
  ...
  const issues: NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateLedgerIssueV1[] = [];
  ...
  if (!Array.isArray(value.artifacts) || value.artifacts.length !== 3) {
    ...
    for (const [
      index,
      expected,
    ] of NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_ARTIFACT_SPECS_V1.entries()) {
  ...
  return deepFreezeOwned({
    ok: true as const,
    value:
      value as unknown as NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleLedgerV1,
  });
}
...
export function boundedIntervalAngleBoundTupleCardinalityJsonDifferencePaths(
  left: unknown,
  right: unknown,
  path = '$',
): string[] {
  ...
  if (Array.isArray(left) && Array.isArray(right)) {
    ...
    for (let index = 0; index < Math.max(left.length, right.length); index += 1) {
      ...
      if (!Object.hasOwn(left, index) || !Object.hasOwn(right, index)) differences.push(childPath);
        ...
        differences.push(
          ...boundedIntervalAngleBoundTupleCardinalityJsonDifferencePaths(
            left[index],
            right[index],
            childPath,
          ),
...
export type NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBuiltFileV1 = Readonly<{
  artifactId: string | null;
  path: string;
  text: string;
}>;

export type NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBuildV1 = Readonly<{
  ledger: NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleLedgerV1;
  files: readonly NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBuiltFileV1[];
}>;

export function buildNegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleV1(): NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBuildV1 {
  if (
    !parseArtifactContractV1(
      NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_FOLD_CONTROL_SOURCE_V1,
    ).ok
  ) {
    throw new TypeError('accepted interval-angle-bound tuple-cardinality control no longer parses');
  }
  const differences = boundedIntervalAngleBoundTupleCardinalityJsonDifferencePaths(
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_FOLD_CONTROL_SOURCE_V1,
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.sourceDocument,
  );
  if (
    !sameStableJson(
      differences,
    ...
    throw new TypeError('bounded interval-angle-bound tuple-cardinality delta changed');
  }
  ...
  if (
    ...
    throw new TypeError('bounded interval-angle-bound tuple-cardinality parser oracle changed');
  }
  const textByArtifactId = new Map<string, string>([
    ['bundle-readme', NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_README_V1],
    [
      CONTROL_ARTIFACT_ID,
      jsonLine(NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_FOLD_CONTROL_SOURCE_V1),
    ],
    [
      SOURCE_ARTIFACT_ID,
      jsonLine(NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.sourceDocument),
    ],
  ]);
  const artifacts = NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_ARTIFACT_SPECS_V1.map(
    (spec) => {
      const text = textByArtifactId.get(spec.artifactId);
      if (text === undefined)
        throw new TypeError(
          `missing bounded-interval-angle-bound-tuple-cardinality artifact ${spec.artifactId}`,
        );
      return { ...spec, sha256: sha256Prefixed(text) as `sha256:${string}` };
    },
  );
  const ledger: NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleLedgerV1 = {
    schemaVersion: 1,
    schemaId: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID,
    recordType:
      NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE,
  ...
  const files: NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBuiltFileV1[] =
    artifacts.map((artifact) => {
      const text = textByArtifactId.get(artifact.artifactId);
      if (text === undefined)
        throw new TypeError(
          `missing bounded-interval-angle-bound-tuple-cardinality artifact ${artifact.artifactId}`,
        );
      return { artifactId: artifact.artifactId, path: artifact.path, text };
    });
  files.push({
    artifactId: null,
    path: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    text: jsonLine(ledger),
  });
  return deepFreezeOwned({ ledger, files });
}

export async function writeNegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBuildV1> {
  const built = buildNegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleV1();
  ...
  if (existing.some((entry) => !entry.isFile() || !expectedNames.has(entry.name))) {
    throw new TypeError(
      'negative path bounded-interval-angle-bound-tuple-cardinality candidate directory contains an unexpected entry',
    );
  }
  await Promise.all(
...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_REASON_CODES = [
  'ledger-unreadable',
  'ledger-invalid',
...
export type NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateReasonCodeV1 =
  (typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_REASON_CODES)[number];
...
export type NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateVerificationResultV1 =
  Readonly<{
    schemaVersion: 1;
    recordType: 'm0f-neg-path-bounded-interval-angle-bound-tuple-cardinality-candidate-bundle-verification-result';
    contractStatus: 'candidate';
    scientificClaim: false;
    vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH-V1';
    scope: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCOPE;
    ...
    reasonCodes: readonly NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateReasonCodeV1[];
    checks: VerificationChecks;
  }>;

interface MutableVerificationState {
  reasons: Set<NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateReasonCodeV1>;
...
): NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateVerificationResultV1 {
  const reasonCodes =
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_REASON_CODES.filter((code) =>
      state.reasons.has(code),
    );
  return deepFreezeOwned({
    schemaVersion: 1 as const,
    recordType:
      'm0f-neg-path-bounded-interval-angle-bound-tuple-cardinality-candidate-bundle-verification-result' as const,
    contractStatus: 'candidate' as const,
    scientificClaim: false as const,
    vectorSetId:
      'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUND-TUPLE-CARDINALITY-MISMATCH-V1' as const,
    scope: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_SCOPE,
    declaredBoundedInterpolationIntervalAngleBoundTupleCardinalityParserOnly: true as const,
...
async function canonicalCaseIsAbsent(): Promise<boolean | undefined> {
  try {
    const parsed = parseFixtureManifest(
      JSON.parse(
        await readFile(
          resolve(NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANONICAL_MANIFEST_PATH),
          'utf8',
        ),
      ) as unknown,
    );
    ...
    return !parsed.manifest.fixtures.some(
      (fixture) => fixture.id === NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_ID,
    );
  } catch {
    return undefined;
  }
...
export async function verifyNegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundedIntervalAngleBoundTupleCardinalityCandidateVerificationResultV1> {
  ...
  try {
    ...
    try {
      ledgerText = await readFile(
        resolve(
          absoluteDirectory,
          NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME,
        ),
        'utf8',
      );
    ...
    const parsedLedger =
      parseNegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleLedgerV1(ledgerDocument);
    if (!parsedLedger.ok) {
    ...
    if (source === undefined) {
      ...
      if (
        control !== undefined &&
        sameStableJson(
          boundedIntervalAngleBoundTupleCardinalityJsonDifferencePaths(control, source),
          NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUND_TUPLE_CARDINALITY_CASE_SPEC_V1.changedPaths,
        )
      ) {
    ...
    const regenerated = buildNegPathBoundedIntervalAngleBoundTupleCardinalityCandidateBundleV1();
