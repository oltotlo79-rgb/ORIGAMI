...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCHEMA_ID =
  'https://oridesign.local/schemas/m0f/neg-path-bounded-interval-angle-bounds-inverted-candidate-bundle-ledger-v1.schema.json' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_RECORD_TYPE =
  'm0f-neg-path-bounded-interval-angle-bounds-inverted-candidate-bundle-ledger' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCOPE =
  'project-authored-exact-negative-artifact-contract-bounded-interpolation-interval-angle-bound-ordering-and-containment-parser-replay-only' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_GENERATOR_ID =
  'oridesign-neg-path-bounded-interval-angle-bounds-inverted-candidate-bundle' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_GENERATOR_VERSION =
  '1.0.0-candidate' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY =
  'tests/candidate-vectors/NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_LEDGER_FILENAME =
  'candidate-bundle-ledger.json' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANONICAL_MANIFEST_PATH =
  'tests/fixtures/manifest.json' as const;
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_ID =
  'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED' as const;

const SOURCE_REFERENCE_ID =
  'oridesign-neg-path-bounded-interval-angle-bounds-inverted-candidate-v1' as const;
const CONTROL_ARTIFACT_ID = 'control-fold' as const;
const SOURCE_ARTIFACT_ID = 'source-path-bounded-interval-angle-bounds-inverted' as const;
const SHA256_PATTERN = /^sha256:[0-9a-f]{64}$/;

export type NegPathBoundedIntervalAngleBoundsInvertedSourceDocumentV1 =
  NegPathAngleBoundSourceDocumentV1;

function ownedAcceptedControl(): NegPathBoundedIntervalAngleBoundsInvertedSourceDocumentV1 {
...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_FOLD_CONTROL_SOURCE_V1 =
  deepFreezeOwned(ownedAcceptedControl());

function boundedIntervalAngleBoundsInvertedSource(): NegPathBoundedIntervalAngleBoundsInvertedSourceDocumentV1 {
  const source = structuredClone(
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_FOLD_CONTROL_SOURCE_V1,
  );
  ...
  if (
    ...
    throw new TypeError(
      'fixed bounded-interpolation interval-angle-bound anchor drifted before inversion',
    );
  }
  bounds[0][0] = (3 * Math.PI) / 4;
  return source;
}

type ExpectedIssueV1 = Readonly<{ path: string; code: string }>;

export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1 = deepFreezeOwned({
  caseId: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_ID,
  controlArtifactId: CONTROL_ARTIFACT_ID,
  mutationKind: 'raise-first-interval-angle-lower-bound-above-its-upper-bound',
  changedPaths: ['$.pathCandidate.segments[0].motion.intervalAngleBoundsByCrease[0].bounds[0][0]'],

  sourceArtifactId: SOURCE_ARTIFACT_ID,
  sourcePath: 'path-bounded-interval-angle-bounds-inverted.json',
  sourceDocument: boundedIntervalAngleBoundsInvertedSource(),
  expectedIssues: [
    {
      path: '$.pathCandidate.segments[0].motion.intervalAngleBoundsByCrease[0].bounds[0]',
      code: 'invalid-bounds',
    },
    {
...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_README_V1 = `# NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED exact-negative candidate vector
...
export type NegPathBoundedIntervalAngleBoundsInvertedArtifactProvenanceV1 = Readonly<{
...
export type NegPathBoundedIntervalAngleBoundsInvertedArtifactLedgerEntryV1 = Readonly<{
  artifactId: string;
  ...
  licenseSpdx: 'MIT';
  provenance: NegPathBoundedIntervalAngleBoundsInvertedArtifactProvenanceV1;
}>;

function artifactProvenance(
  dependsOnArtifactIds: readonly (typeof CONTROL_ARTIFACT_ID)[],
): NegPathBoundedIntervalAngleBoundsInvertedArtifactProvenanceV1 {
  return {
...
type ArtifactSpecV1 = Omit<
  NegPathBoundedIntervalAngleBoundsInvertedArtifactLedgerEntryV1,
  'sha256'
>;

export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_ARTIFACT_SPECS_V1 = deepFreezeOwned([
  {
  ...
  },
  {
    ...
    path: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.sourcePath,
    mediaType: 'application/json',
    licenseSpdx: 'MIT',
...
export type NegPathBoundedIntervalAngleBoundsInvertedCaseLedgerRowV1 = Readonly<{
  caseIndex: 0;
  caseId: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_ID;
  controlArtifactId: typeof CONTROL_ARTIFACT_ID;
  mutationKind: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.mutationKind;
...
const GENERATOR = deepFreezeOwned({
  generatorId: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_GENERATOR_ID,
  generatorVersion:
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_GENERATOR_VERSION,
...
const SOURCE_PROVENANCE = deepFreezeOwned({
  ...
  title:
    'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED project-authored bounded-interpolation interval-angle-bound ordering and containment parser vector',
  authors: ['OriDesign contributors'],
  redistribution: 'allowed' as const,
  licenseSpdx: 'MIT' as const,
});

function ledgerCases(): readonly NegPathBoundedIntervalAngleBoundsInvertedCaseLedgerRowV1[] {
  return [
    {
      caseIndex: 0,
      caseId: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_ID,
      controlArtifactId: CONTROL_ARTIFACT_ID,
      mutationKind: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.mutationKind,
      changedPaths: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.changedPaths,
      sourceArtifactId: SOURCE_ARTIFACT_ID,
      sourcePath: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.sourcePath,
      expectedOutcome: 'rejected',
      expectedIssues: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.expectedIssues,
    },
  ];
}

export type NegPathBoundedIntervalAngleBoundsInvertedCandidateBundleLedgerV1 = Readonly<{
  schemaVersion: 1;
  schemaId: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCHEMA_ID;
  recordType: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_RECORD_TYPE;
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED-V1';
  scope: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCOPE;
  declaredBoundedInterpolationIntervalAngleBoundOrderingParserOnly: true;
  declaredBoundedInterpolationIntervalAngleBoundTupleCardinalityParserOnly: false;
  declaredBoundedInterpolationFiniteIntervalAngleBoundsParserOnly: false;
  ...
  canonicalManifestPath: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANONICAL_MANIFEST_PATH;
  ...
  cases: readonly NegPathBoundedIntervalAngleBoundsInvertedCaseLedgerRowV1[];
  artifacts: readonly NegPathBoundedIntervalAngleBoundsInvertedArtifactLedgerEntryV1[];
}>;

export type NegPathBoundedIntervalAngleBoundsInvertedCandidateLedgerIssueV1 = Readonly<{
  path: string;
  code:
    | 'invalid-snapshot'
    | 'invalid-object'
...
export type NegPathBoundedIntervalAngleBoundsInvertedCandidateLedgerParseResultV1 =
  | Readonly<{
      ok: true;
      value: NegPathBoundedIntervalAngleBoundsInvertedCandidateBundleLedgerV1;
    }>
  | Readonly<{
      ok: false;
      error: readonly NegPathBoundedIntervalAngleBoundsInvertedCandidateLedgerIssueV1[];
    }>;
const ROOT_KEYS = [
  'schemaVersion',
  'schemaId',
  ...
  'vectorSetId',
  'scope',
  'declaredBoundedInterpolationIntervalAngleBoundOrderingParserOnly',
  'declaredBoundedInterpolationIntervalAngleBoundTupleCardinalityParserOnly',
...
const FIXED_LITERALS = [
  ['schemaVersion', 1],
  ['schemaId', NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCHEMA_ID],
  ['recordType', NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_RECORD_TYPE],
  ['contractStatus', 'candidate'],
  ['scientificClaim', false],
  ['vectorSetId', 'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED-V1'],
  ['scope', NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCOPE],
  ['declaredBoundedInterpolationIntervalAngleBoundOrderingParserOnly', true],
  ['declaredBoundedInterpolationIntervalAngleBoundTupleCardinalityParserOnly', false],
  ['declaredBoundedInterpolationFiniteIntervalAngleBoundsParserOnly', false],
  ['declaredBoundedInterpolationFiniteAnglesParserOnly', false],
  ...
  [
    'canonicalManifestPath',
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANONICAL_MANIFEST_PATH,
  ],
  ['canonicalManifestRegistration', 'not-registered'],
  ['canonicalPromotionClaimed', false],
  ['canonicalPathMutationFamilyComplete', false],
...
function addLedgerIssue(
  issues: NegPathBoundedIntervalAngleBoundsInvertedCandidateLedgerIssueV1[],
  path: string,
  code: NegPathBoundedIntervalAngleBoundsInvertedCandidateLedgerIssueV1['code'],
  message: string,
): void {
...
export function parseNegPathBoundedIntervalAngleBoundsInvertedCandidateBundleLedgerV1(
  supplied: unknown,
): NegPathBoundedIntervalAngleBoundsInvertedCandidateLedgerParseResultV1 {
  ...
  const issues: NegPathBoundedIntervalAngleBoundsInvertedCandidateLedgerIssueV1[] = [];
  ...
  if (!Array.isArray(value.artifacts) || value.artifacts.length !== 3) {
    ...
    for (const [
      index,
      expected,
    ] of NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_ARTIFACT_SPECS_V1.entries()) {
  ...
  return deepFreezeOwned({
    ok: true as const,
    value: value as unknown as NegPathBoundedIntervalAngleBoundsInvertedCandidateBundleLedgerV1,
  });
}
...
export function boundedIntervalAngleBoundsInvertedJsonDifferencePaths(
  left: unknown,
  right: unknown,
  path = '$',
): string[] {
  ...
  if (Array.isArray(left) && Array.isArray(right)) {
    ...
    for (let index = 0; index < Math.max(left.length, right.length); index += 1) {
      ...
      if (!Object.hasOwn(left, index) || !Object.hasOwn(right, index)) differences.push(childPath);
        ...
        differences.push(
          ...boundedIntervalAngleBoundsInvertedJsonDifferencePaths(
            left[index],
            right[index],
            childPath,
          ),
...
export type NegPathBoundedIntervalAngleBoundsInvertedCandidateBuiltFileV1 = Readonly<{
  artifactId: string | null;
  path: string;
  text: string;
}>;

export type NegPathBoundedIntervalAngleBoundsInvertedCandidateBuildV1 = Readonly<{
  ledger: NegPathBoundedIntervalAngleBoundsInvertedCandidateBundleLedgerV1;
  files: readonly NegPathBoundedIntervalAngleBoundsInvertedCandidateBuiltFileV1[];
}>;

export function buildNegPathBoundedIntervalAngleBoundsInvertedCandidateBundleV1(): NegPathBoundedIntervalAngleBoundsInvertedCandidateBuildV1 {
  if (
    !parseArtifactContractV1(NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_FOLD_CONTROL_SOURCE_V1)
      .ok
  ) {
    throw new TypeError('accepted interval-angle-bound ordering control no longer parses');
  }
  const differences = boundedIntervalAngleBoundsInvertedJsonDifferencePaths(
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_FOLD_CONTROL_SOURCE_V1,
    NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.sourceDocument,
  );
  if (
    !sameStableJson(
      differences,
      NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.changedPaths,
    )
  ) {
    throw new TypeError('bounded interval-angle-bound inversion delta changed');
  }
  ...
  if (
    ...
    !sameStableJson(
      ...
      NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.expectedIssues,
    )
  ) {
    throw new TypeError('bounded interval-angle-bound inversion parser oracle changed');
  }
  const textByArtifactId = new Map<string, string>([
    ['bundle-readme', NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_README_V1],
    [
      CONTROL_ARTIFACT_ID,
      jsonLine(NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_FOLD_CONTROL_SOURCE_V1),
    ],
    [
      SOURCE_ARTIFACT_ID,
      jsonLine(NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.sourceDocument),
    ],
  ]);
  const artifacts = NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_ARTIFACT_SPECS_V1.map(
    (spec) => {
      const text = textByArtifactId.get(spec.artifactId);
      if (text === undefined)
        throw new TypeError(
          `missing bounded-interval-angle-bounds-inverted artifact ${spec.artifactId}`,
        );
      return { ...spec, sha256: sha256Prefixed(text) as `sha256:${string}` };
    },
  );
  const ledger: NegPathBoundedIntervalAngleBoundsInvertedCandidateBundleLedgerV1 = {
    schemaVersion: 1,
    schemaId: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCHEMA_ID,
    recordType: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_RECORD_TYPE,
    contractStatus: 'candidate',
    ...
    declaredBoundedInterpolationAngleContainmentParserOnly: true,
    declaredBoundedInterpolationKnotTimeStrictMonotonicityParserOnly: false,
    canonicalManifestPath: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANONICAL_MANIFEST_PATH,
    canonicalManifestRegistration: 'not-registered',
    canonicalPromotionClaimed: false,
    canonicalPathMutationFamilyComplete: false,
    representationSelectionEstablished: false,
  ...
  const files: NegPathBoundedIntervalAngleBoundsInvertedCandidateBuiltFileV1[] = artifacts.map(
    (artifact) => {
      const text = textByArtifactId.get(artifact.artifactId);
      if (text === undefined)
        throw new TypeError(
          `missing bounded-interval-angle-bounds-inverted artifact ${artifact.artifactId}`,
        );
  ...
  files.push({
    artifactId: null,
    path: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    text: jsonLine(ledger),
  });
  return deepFreezeOwned({ ledger, files });
}

export async function writeNegPathBoundedIntervalAngleBoundsInvertedCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundedIntervalAngleBoundsInvertedCandidateBuildV1> {
  const built = buildNegPathBoundedIntervalAngleBoundsInvertedCandidateBundleV1();
  ...
  if (existing.some((entry) => !entry.isFile() || !expectedNames.has(entry.name))) {
    throw new TypeError(
      'negative path bounded-interval-angle-bounds-inverted candidate directory contains an unexpected entry',
    );
  }
  await Promise.all(
...
export const NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_REASON_CODES = [
  'ledger-unreadable',
  'ledger-invalid',
...
export type NegPathBoundedIntervalAngleBoundsInvertedCandidateReasonCodeV1 =
  (typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_REASON_CODES)[number];
...
export type NegPathBoundedIntervalAngleBoundsInvertedCandidateVerificationResultV1 = Readonly<{
  schemaVersion: 1;
  recordType: 'm0f-neg-path-bounded-interval-angle-bounds-inverted-candidate-bundle-verification-result';
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED-V1';
  scope: typeof NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCOPE;
  ...
  reasonCodes: readonly NegPathBoundedIntervalAngleBoundsInvertedCandidateReasonCodeV1[];
  checks: VerificationChecks;
}>;

interface MutableVerificationState {
  reasons: Set<NegPathBoundedIntervalAngleBoundsInvertedCandidateReasonCodeV1>;
...
): NegPathBoundedIntervalAngleBoundsInvertedCandidateVerificationResultV1 {
  const reasonCodes = NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_REASON_CODES.filter(
    (code) => state.reasons.has(code),
  );
  return deepFreezeOwned({
    schemaVersion: 1 as const,
    recordType:
      'm0f-neg-path-bounded-interval-angle-bounds-inverted-candidate-bundle-verification-result' as const,
    contractStatus: 'candidate' as const,
    scientificClaim: false as const,
    vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-INTERVAL-ANGLE-BOUNDS-INVERTED-V1' as const,
    scope: NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_SCOPE,
    declaredBoundedInterpolationIntervalAngleBoundOrderingParserOnly: true as const,
    declaredBoundedInterpolationIntervalAngleBoundTupleCardinalityParserOnly: false as const,
    declaredBoundedInterpolationFiniteIntervalAngleBoundsParserOnly: false as const,
    ...
    declaredBoundedInterpolationAngleContainmentParserOnly: true as const,
...
async function canonicalCaseIsAbsent(): Promise<boolean | undefined> {
  try {
    const parsed = parseFixtureManifest(
      JSON.parse(
        await readFile(
          resolve(NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANONICAL_MANIFEST_PATH),
          'utf8',
        ),
      ) as unknown,
    );
    ...
    return !parsed.manifest.fixtures.some(
      (fixture) => fixture.id === NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_ID,
    );
  } catch {
    return undefined;
  }
...
export async function verifyNegPathBoundedIntervalAngleBoundsInvertedCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundedIntervalAngleBoundsInvertedCandidateVerificationResultV1> {
  ...
  try {
    ...
    try {
      ledgerText = await readFile(
        resolve(
          absoluteDirectory,
          NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CANDIDATE_BUNDLE_LEDGER_FILENAME,
        ),
        'utf8',
      );
    ...
    const parsedLedger =
      parseNegPathBoundedIntervalAngleBoundsInvertedCandidateBundleLedgerV1(ledgerDocument);
    if (!parsedLedger.ok) {
    ...
    if (source === undefined) {
      ...
      if (
        control !== undefined &&
        sameStableJson(
          boundedIntervalAngleBoundsInvertedJsonDifferencePaths(control, source),
          NEG_PATH_BOUNDED_INTERVAL_ANGLE_BOUNDS_INVERTED_CASE_SPEC_V1.changedPaths,
        )
      ) {
    ...
    const regenerated = buildNegPathBoundedIntervalAngleBoundsInvertedCandidateBundleV1();
