...
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCHEMA_ID =
  'https://oridesign.local/schemas/m0f/neg-path-polynomial-non-finite-coefficient-candidate-bundle-ledger-v1.schema.json' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_RECORD_TYPE =
  'm0f-neg-path-polynomial-non-finite-coefficient-candidate-bundle-ledger' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCOPE =
  'project-authored-exact-negative-artifact-contract-piecewise-polynomial-finite-coefficients-parser-replay-only' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_GENERATOR_ID =
  'oridesign-neg-path-polynomial-non-finite-coefficient-candidate-bundle' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_GENERATOR_VERSION =
  '1.0.0-candidate' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY =
  'tests/candidate-vectors/NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_LEDGER_FILENAME =
  'candidate-bundle-ledger.json' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANONICAL_MANIFEST_PATH =
  'tests/fixtures/manifest.json' as const;
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_ID =
  'NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT' as const;

const SOURCE_REFERENCE_ID =
  'oridesign-neg-path-polynomial-non-finite-coefficient-candidate-v1' as const;
const CONTROL_ARTIFACT_ID = 'control-design' as const;
const SOURCE_ARTIFACT_ID = 'source-path-polynomial-non-finite-coefficient' as const;
const SHA256_PATTERN = /^sha256:[0-9a-f]{64}$/;

export type NegPathPolynomialNonFiniteCoefficientSourceDocumentV1 =
  NegPathPolynomialCoefficientDegreeSourceDocumentV1;

type PolynomialNonFiniteCoefficientPathSegmentV1 =
  NegPathPolynomialNonFiniteCoefficientSourceDocumentV1['pathCandidate']['segments'][number];

function isFixedDegreeOnePolynomialSegment(
  segment: PolynomialNonFiniteCoefficientPathSegmentV1 | undefined,
  t0: number,
  t1: number,
): segment is PolynomialNonFiniteCoefficientPathSegmentV1 {
  if (
    segment?.t0 !== t0 ||
    segment.t1 !== t1 ||
...
function polynomialNonFiniteCoefficientControl(): NegPathPolynomialNonFiniteCoefficientSourceDocumentV1 {
...
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_DESIGN_CONTROL_SOURCE_V1 = deepFreezeOwned(
  polynomialNonFiniteCoefficientControl(),
);

function polynomialNonFiniteCoefficientSource(): NegPathPolynomialNonFiniteCoefficientSourceDocumentV1 {
  ...
  if (
    ...
    throw new TypeError('fixed polynomial control anchor drifted before coefficient replacement');
  }
  const coefficientRow = firstSegment.motion.coefficientsByCrease[0]?.coefficients[0];
  if (coefficientRow?.length !== 2 || coefficientRow[0] !== 0 || coefficientRow[1] !== Math.PI) {
    throw new TypeError('fixed polynomial coefficient row is missing');
  }
  (coefficientRow as unknown[])[1] = null;
  return source;
}

type ExpectedIssueV1 = Readonly<{ path: string; code: string }>;

export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1 = deepFreezeOwned({
  caseId: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_ID,
  controlArtifactId: CONTROL_ARTIFACT_ID,
  mutationKind: 'replace-terminal-polynomial-coefficient-with-json-null',
  changedPaths: ['$.pathCandidate.segments[0].motion.coefficientsByCrease[0].coefficients[0][1]'],
  sourceArtifactId: SOURCE_ARTIFACT_ID,
  sourcePath: 'path-polynomial-non-finite-coefficient.json',
  sourceDocument: polynomialNonFiniteCoefficientSource(),
  expectedIssues: [
    {
...
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_README_V1 = `# NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT exact-negative candidate vector
...
export type NegPathPolynomialNonFiniteCoefficientArtifactProvenanceV1 = Readonly<{
...
export type NegPathPolynomialNonFiniteCoefficientArtifactLedgerEntryV1 = Readonly<{
  artifactId: string;
  ...
  licenseSpdx: 'MIT';
  provenance: NegPathPolynomialNonFiniteCoefficientArtifactProvenanceV1;
}>;

function artifactProvenance(
  dependsOnArtifactIds: readonly (typeof CONTROL_ARTIFACT_ID)[],
): NegPathPolynomialNonFiniteCoefficientArtifactProvenanceV1 {
  return {
...
type ArtifactSpecV1 = Omit<NegPathPolynomialNonFiniteCoefficientArtifactLedgerEntryV1, 'sha256'>;

export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_ARTIFACT_SPECS_V1 = deepFreezeOwned([
  {
  ...
  },
  {
    ...
    path: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.sourcePath,
    mediaType: 'application/json',
    licenseSpdx: 'MIT',
...
export type NegPathPolynomialNonFiniteCoefficientCaseLedgerRowV1 = Readonly<{
  caseIndex: 0;
  caseId: typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_ID;
  controlArtifactId: typeof CONTROL_ARTIFACT_ID;
  mutationKind: typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.mutationKind;
...
const GENERATOR = deepFreezeOwned({
  generatorId: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_GENERATOR_ID,
  generatorVersion: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_GENERATOR_VERSION,
...
const SOURCE_PROVENANCE = deepFreezeOwned({
  ...
  title:
    'NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT project-authored piecewise-polynomial finite-coefficients parser vector',
  authors: ['OriDesign contributors'],
  redistribution: 'allowed' as const,
  licenseSpdx: 'MIT' as const,
});

function ledgerCases(): readonly NegPathPolynomialNonFiniteCoefficientCaseLedgerRowV1[] {
  return [
    {
      caseIndex: 0,
      caseId: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_ID,
      controlArtifactId: CONTROL_ARTIFACT_ID,
      mutationKind: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.mutationKind,
      changedPaths: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.changedPaths,
      sourceArtifactId: SOURCE_ARTIFACT_ID,
      sourcePath: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.sourcePath,
      expectedOutcome: 'rejected',
      expectedIssues: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.expectedIssues,
    },
  ];
}

export type NegPathPolynomialNonFiniteCoefficientCandidateBundleLedgerV1 = Readonly<{
  schemaVersion: 1;
  schemaId: typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCHEMA_ID;
  recordType: typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_RECORD_TYPE;
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT-V1';
  scope: typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCOPE;
  ...
  canonicalManifestPath: typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANONICAL_MANIFEST_PATH;
  ...
  cases: readonly NegPathPolynomialNonFiniteCoefficientCaseLedgerRowV1[];
  artifacts: readonly NegPathPolynomialNonFiniteCoefficientArtifactLedgerEntryV1[];
}>;

export type NegPathPolynomialNonFiniteCoefficientCandidateLedgerIssueV1 = Readonly<{
  path: string;
  code:
    | 'invalid-snapshot'
    | 'invalid-object'
...
export type NegPathPolynomialNonFiniteCoefficientCandidateLedgerParseResultV1 =
  | Readonly<{
      ok: true;
      value: NegPathPolynomialNonFiniteCoefficientCandidateBundleLedgerV1;
    }>
  | Readonly<{
      ok: false;
      error: readonly NegPathPolynomialNonFiniteCoefficientCandidateLedgerIssueV1[];
    }>;
...
const ROOT_KEYS = [
  ...
  'vectorSetId',
  'scope',
  'declaredPiecewisePolynomialFiniteCoefficientsParserOnly',
...
const FIXED_LITERALS = [
  ['schemaVersion', 1],
  ['schemaId', NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCHEMA_ID],
  ['recordType', NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_RECORD_TYPE],
  ['contractStatus', 'candidate'],
  ['scientificClaim', false],
  ['vectorSetId', 'NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT-V1'],
  ['scope', NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCOPE],
  ['declaredPiecewisePolynomialFiniteCoefficientsParserOnly', true],
  ['declaredPiecewisePolynomialNonEmptyCoefficientRowsParserOnly', false],
  ['declaredPiecewisePolynomialUniqueCoefficientCreaseRowsParserOnly', false],
  ['declaredPiecewisePolynomialUniqueDerivativeBoundCreaseRowsParserOnly', false],
  ['declaredPiecewisePolynomialCoefficientDegreeCardinalityParserOnly', false],
  ['pathTimeCoverageEstablished', false],
  ['canonicalManifestPath', NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANONICAL_MANIFEST_PATH],
  ['canonicalManifestRegistration', 'not-registered'],
  ['canonicalPromotionClaimed', false],
  ['canonicalPathMutationFamilyComplete', false],
  ['representationSelectionEstablished', false],
...
function addLedgerIssue(
  issues: NegPathPolynomialNonFiniteCoefficientCandidateLedgerIssueV1[],
  path: string,
  code: NegPathPolynomialNonFiniteCoefficientCandidateLedgerIssueV1['code'],
  message: string,
): void {
...
export function parseNegPathPolynomialNonFiniteCoefficientCandidateBundleLedgerV1(
  supplied: unknown,
): NegPathPolynomialNonFiniteCoefficientCandidateLedgerParseResultV1 {
  ...
  const issues: NegPathPolynomialNonFiniteCoefficientCandidateLedgerIssueV1[] = [];
  ...
  if (!Array.isArray(value.cases) || value.cases.length !== 1) {
    ...
    addLedgerIssue(
      ...
      '$.cases[0]',
      'invalid-case',
      'case identity, control link, non-finite-coefficient delta, path, or complete issue oracle differs',
    );
  }
  if (!Array.isArray(value.artifacts) || value.artifacts.length !== 3) {
    ...
    for (const [
      index,
      expected,
    ] of NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_ARTIFACT_SPECS_V1.entries()) {
  ...
  return deepFreezeOwned({
    ok: true as const,
    value: value as unknown as NegPathPolynomialNonFiniteCoefficientCandidateBundleLedgerV1,
  });
}
...
export function polynomialNonFiniteCoefficientJsonDifferencePaths(
  left: unknown,
  right: unknown,
  path = '$',
): string[] {
  ...
  if (isRecord(left) && isRecord(right)) {
    ...
    for (const key of keys) {
      ...
      if (!Object.hasOwn(left, key) || !Object.hasOwn(right, key)) differences.push(childPath);
        ...
        differences.push(
          ...polynomialNonFiniteCoefficientJsonDifferencePaths(left[key], right[key], childPath),
        );
    }
    return differences;
  }
...
export type NegPathPolynomialNonFiniteCoefficientCandidateBuiltFileV1 = Readonly<{
  artifactId: string | null;
  path: string;
  text: string;
}>;

export type NegPathPolynomialNonFiniteCoefficientCandidateBuildV1 = Readonly<{
  ledger: NegPathPolynomialNonFiniteCoefficientCandidateBundleLedgerV1;
  files: readonly NegPathPolynomialNonFiniteCoefficientCandidateBuiltFileV1[];
}>;

export function buildNegPathPolynomialNonFiniteCoefficientCandidateBundleV1(): NegPathPolynomialNonFiniteCoefficientCandidateBuildV1 {
  if (
    !parseArtifactContractV1(NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_DESIGN_CONTROL_SOURCE_V1).ok
  ) {
    throw new TypeError('accepted polynomial finite-coefficient control no longer parses');
  }
  const differences = polynomialNonFiniteCoefficientJsonDifferencePaths(
    NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_DESIGN_CONTROL_SOURCE_V1,
  ...
  if (
    !sameStableJson(
      differences,
      NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.changedPaths,
    )
  ) {
    throw new TypeError('polynomial non-finite-coefficient control delta changed');
  }
  ...
  if (
    ...
    throw new TypeError('polynomial non-finite-coefficient parser oracle changed');
  }
  const textByArtifactId = new Map<string, string>([
    ['bundle-readme', NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_README_V1],
    [
      CONTROL_ARTIFACT_ID,
      jsonLine(NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_DESIGN_CONTROL_SOURCE_V1),
    ],
    [
      SOURCE_ARTIFACT_ID,
      jsonLine(NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.sourceDocument),
    ],
  ]);
  const artifacts = NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_ARTIFACT_SPECS_V1.map((spec) => {
    const text = textByArtifactId.get(spec.artifactId);
    if (text === undefined)
      throw new TypeError(`missing polynomial non-finite-coefficient artifact ${spec.artifactId}`);
    return { ...spec, sha256: sha256Prefixed(text) as `sha256:${string}` };
  });
  const ledger: NegPathPolynomialNonFiniteCoefficientCandidateBundleLedgerV1 = {
    schemaVersion: 1,
    schemaId: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCHEMA_ID,
    recordType: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_RECORD_TYPE,
    contractStatus: 'candidate',
  ...
  const files: NegPathPolynomialNonFiniteCoefficientCandidateBuiltFileV1[] = artifacts.map(
    (artifact) => {
      const text = textByArtifactId.get(artifact.artifactId);
      if (text === undefined)
        throw new TypeError(
          `missing polynomial non-finite-coefficient artifact ${artifact.artifactId}`,
        );
  ...
  files.push({
    artifactId: null,
    path: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    text: jsonLine(ledger),
  });
  return deepFreezeOwned({ ledger, files });
}

export async function writeNegPathPolynomialNonFiniteCoefficientCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathPolynomialNonFiniteCoefficientCandidateBuildV1> {
  const built = buildNegPathPolynomialNonFiniteCoefficientCandidateBundleV1();
  ...
  if (existing.some((entry) => !entry.isFile() || !expectedNames.has(entry.name))) {
    throw new TypeError(
      'negative path polynomial non-finite-coefficient candidate directory contains an unexpected entry',
    );
  }
  await Promise.all(
...
export const NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_REASON_CODES = [
  'ledger-unreadable',
  'ledger-invalid',
...
export type NegPathPolynomialNonFiniteCoefficientCandidateReasonCodeV1 =
  (typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_REASON_CODES)[number];
...
export type NegPathPolynomialNonFiniteCoefficientCandidateVerificationResultV1 = Readonly<{
  schemaVersion: 1;
  recordType: 'm0f-neg-path-polynomial-non-finite-coefficient-candidate-bundle-verification-result';
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT-V1';
  scope: typeof NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCOPE;
  ...
  reasonCodes: readonly NegPathPolynomialNonFiniteCoefficientCandidateReasonCodeV1[];
  checks: VerificationChecks;
}>;

interface MutableVerificationState {
  reasons: Set<NegPathPolynomialNonFiniteCoefficientCandidateReasonCodeV1>;
...
): NegPathPolynomialNonFiniteCoefficientCandidateVerificationResultV1 {
  const reasonCodes = NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_REASON_CODES.filter(
    (code) => state.reasons.has(code),
  );
  return deepFreezeOwned({
    schemaVersion: 1 as const,
    recordType:
      'm0f-neg-path-polynomial-non-finite-coefficient-candidate-bundle-verification-result' as const,
    contractStatus: 'candidate' as const,
    scientificClaim: false as const,
    vectorSetId: 'NEG-PATH-MUTATION-POLYNOMIAL-NON-FINITE-COEFFICIENT-V1' as const,
    scope: NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_SCOPE,
    declaredPiecewisePolynomialFiniteCoefficientsParserOnly: true as const,
    declaredPiecewisePolynomialNonEmptyCoefficientRowsParserOnly: false as const,
...
async function canonicalCaseIsAbsent(): Promise<boolean | undefined> {
  try {
    const parsed = parseFixtureManifest(
      JSON.parse(
        await readFile(
          resolve(NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANONICAL_MANIFEST_PATH),
          'utf8',
        ),
      ) as unknown,
    );
    ...
    return !parsed.manifest.fixtures.some(
      (fixture) => fixture.id === NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_ID,
    );
  } catch {
    return undefined;
  }
...
export async function verifyNegPathPolynomialNonFiniteCoefficientCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathPolynomialNonFiniteCoefficientCandidateVerificationResultV1> {
  ...
  try {
    ...
    const parsedLedger =
      parseNegPathPolynomialNonFiniteCoefficientCandidateBundleLedgerV1(ledgerDocument);
    if (!parsedLedger.ok) {
    ...
    const textByPath = new Map<string, string>([
      [NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CANDIDATE_BUNDLE_LEDGER_FILENAME, ledgerText],
    ]);
    ...
    if (source === undefined) {
      ...
      if (
        control !== undefined &&
        sameStableJson(
          polynomialNonFiniteCoefficientJsonDifferencePaths(control, source),
          NEG_PATH_POLYNOMIAL_NON_FINITE_COEFFICIENT_CASE_SPEC_V1.changedPaths,
        )
      ) {
    ...
    const regenerated = buildNegPathPolynomialNonFiniteCoefficientCandidateBundleV1();
