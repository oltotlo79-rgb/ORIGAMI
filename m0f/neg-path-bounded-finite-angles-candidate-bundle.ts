...
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCHEMA_ID =
  'https://oridesign.local/schemas/m0f/neg-path-bounded-finite-angles-candidate-bundle-ledger-v1.schema.json' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_RECORD_TYPE =
  'm0f-neg-path-bounded-finite-angles-candidate-bundle-ledger' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCOPE =
  'project-authored-exact-negative-artifact-contract-bounded-interpolation-finite-angles-parser-replay-only' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_GENERATOR_ID =
  'oridesign-neg-path-bounded-finite-angles-candidate-bundle' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_GENERATOR_VERSION =
  '1.0.0-candidate' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY =
  'tests/candidate-vectors/NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_LEDGER_FILENAME =
  'candidate-bundle-ledger.json' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANONICAL_MANIFEST_PATH =
  'tests/fixtures/manifest.json' as const;
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_ID =
  'NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES' as const;

const SOURCE_REFERENCE_ID = 'oridesign-neg-path-bounded-finite-angles-candidate-v1' as const;
const CONTROL_ARTIFACT_ID = 'control-fold' as const;
const SOURCE_ARTIFACT_ID = 'source-path-bounded-finite-angles' as const;
const SHA256_PATTERN = /^sha256:[0-9a-f]{64}$/;

export type NegPathBoundedFiniteAnglesSourceDocumentV1 = NegPathAngleBoundSourceDocumentV1;

function ownedAcceptedControl(): NegPathBoundedFiniteAnglesSourceDocumentV1 {
...
export const NEG_PATH_BOUNDED_FINITE_ANGLES_FOLD_CONTROL_SOURCE_V1 =
  deepFreezeOwned(ownedAcceptedControl());

function boundedFiniteAnglesSource(): NegPathBoundedFiniteAnglesSourceDocumentV1 {
  const source = structuredClone(NEG_PATH_BOUNDED_FINITE_ANGLES_FOLD_CONTROL_SOURCE_V1);
  const segment = source.pathCandidate.segments[0];
  const angles =
    segment?.motion.kind === 'bounded-interpolation'
      ? segment.motion.anglesByCrease[0]?.angles
      : undefined;
  if (
    ...
    throw new TypeError('fixed bounded-interpolation angle anchor drifted before replacement');
  }
  (angles as unknown[])[0] = null;
  return source;
}

type ExpectedIssueV1 = Readonly<{ path: string; code: string }>;

export const NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1 = deepFreezeOwned({
  caseId: NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_ID,
  controlArtifactId: CONTROL_ARTIFACT_ID,
  mutationKind: 'replace-first-bounded-interpolation-angle-with-json-null',
  changedPaths: ['$.pathCandidate.segments[0].motion.anglesByCrease[0].angles[0]'],

  sourceArtifactId: SOURCE_ARTIFACT_ID,
  sourcePath: 'path-bounded-finite-angles.json',
  sourceDocument: boundedFiniteAnglesSource(),
  expectedIssues: [
    {
      path: '$.pathCandidate.segments[0].motion.anglesByCrease[0].angles[0]',
      code: 'non-finite-number',
    },
  ],
} as const);

export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_README_V1 = `# NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES exact-negative candidate vector
...
export type NegPathBoundedFiniteAnglesArtifactProvenanceV1 = Readonly<{
...
export type NegPathBoundedFiniteAnglesArtifactLedgerEntryV1 = Readonly<{
  artifactId: string;
  ...
  licenseSpdx: 'MIT';
  provenance: NegPathBoundedFiniteAnglesArtifactProvenanceV1;
}>;

function artifactProvenance(
  dependsOnArtifactIds: readonly (typeof CONTROL_ARTIFACT_ID)[],
): NegPathBoundedFiniteAnglesArtifactProvenanceV1 {
  return {
...
type ArtifactSpecV1 = Omit<NegPathBoundedFiniteAnglesArtifactLedgerEntryV1, 'sha256'>;

export const NEG_PATH_BOUNDED_FINITE_ANGLES_ARTIFACT_SPECS_V1 = deepFreezeOwned([
  {
  ...
  },
  {
    ...
    path: NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.sourcePath,
    mediaType: 'application/json',
    licenseSpdx: 'MIT',
...
export type NegPathBoundedFiniteAnglesCaseLedgerRowV1 = Readonly<{
  caseIndex: 0;
  caseId: typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_ID;
  controlArtifactId: typeof CONTROL_ARTIFACT_ID;
  mutationKind: typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.mutationKind;
  changedPaths: readonly ['$.pathCandidate.segments[0].motion.anglesByCrease[0].angles[0]'];
...
const GENERATOR = deepFreezeOwned({
  generatorId: NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_GENERATOR_ID,
  generatorVersion: NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_GENERATOR_VERSION,
...
const SOURCE_PROVENANCE = deepFreezeOwned({
  ...
  title:
    'NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES project-authored bounded-interpolation finite-angles parser vector',
  authors: ['OriDesign contributors'],
  redistribution: 'allowed' as const,
  licenseSpdx: 'MIT' as const,
});

function ledgerCases(): readonly NegPathBoundedFiniteAnglesCaseLedgerRowV1[] {
  return [
    {
      caseIndex: 0,
      caseId: NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_ID,
      controlArtifactId: CONTROL_ARTIFACT_ID,
      mutationKind: NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.mutationKind,
      changedPaths: NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.changedPaths,
      sourceArtifactId: SOURCE_ARTIFACT_ID,
      sourcePath: NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.sourcePath,
      expectedOutcome: 'rejected',
      expectedIssues: NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.expectedIssues,
    },
  ];
}

export type NegPathBoundedFiniteAnglesCandidateBundleLedgerV1 = Readonly<{
  schemaVersion: 1;
  schemaId: typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCHEMA_ID;
  recordType: typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_RECORD_TYPE;
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES-V1';
  scope: typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCOPE;
  declaredBoundedInterpolationFiniteAnglesParserOnly: true;
  ...
  canonicalManifestPath: typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CANONICAL_MANIFEST_PATH;
  ...
  cases: readonly NegPathBoundedFiniteAnglesCaseLedgerRowV1[];
  artifacts: readonly NegPathBoundedFiniteAnglesArtifactLedgerEntryV1[];
}>;

export type NegPathBoundedFiniteAnglesCandidateLedgerIssueV1 = Readonly<{
  path: string;
  code:
    | 'invalid-snapshot'
    | 'invalid-object'
...
export type NegPathBoundedFiniteAnglesCandidateLedgerParseResultV1 =
  | Readonly<{ ok: true; value: NegPathBoundedFiniteAnglesCandidateBundleLedgerV1 }>
  | Readonly<{
      ok: false;
      error: readonly NegPathBoundedFiniteAnglesCandidateLedgerIssueV1[];
    }>;
const ROOT_KEYS = [
  'schemaVersion',
  'schemaId',
...
const FIXED_LITERALS = [
  ['schemaVersion', 1],
  ['schemaId', NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCHEMA_ID],
  ['recordType', NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_RECORD_TYPE],
  ['contractStatus', 'candidate'],
  ['scientificClaim', false],
  ['vectorSetId', 'NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES-V1'],
  ['scope', NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCOPE],
  ['declaredBoundedInterpolationFiniteAnglesParserOnly', true],
  ['declaredBoundedInterpolationFiniteKnotTimesParserOnly', false],
  ['declaredPathCandidateRepresentationVersionParserOnly', false],
  ['declaredPathCandidateRepresentationStatusParserOnly', false],
  ...
  ['declaredBoundedInterpolationAngleContainmentParserOnly', false],
  ['declaredBoundedInterpolationKnotTimeStrictMonotonicityParserOnly', false],
  ['canonicalManifestPath', NEG_PATH_BOUNDED_FINITE_ANGLES_CANONICAL_MANIFEST_PATH],
  ['canonicalManifestRegistration', 'not-registered'],
  ['canonicalPromotionClaimed', false],
  ['canonicalPathMutationFamilyComplete', false],
  ['representationSelectionEstablished', false],
...
function addLedgerIssue(
  issues: NegPathBoundedFiniteAnglesCandidateLedgerIssueV1[],
  path: string,
  code: NegPathBoundedFiniteAnglesCandidateLedgerIssueV1['code'],
  message: string,
): void {
...
export function parseNegPathBoundedFiniteAnglesCandidateBundleLedgerV1(
  supplied: unknown,
): NegPathBoundedFiniteAnglesCandidateLedgerParseResultV1 {
  ...
  const issues: NegPathBoundedFiniteAnglesCandidateLedgerIssueV1[] = [];
  ...
  if (!Array.isArray(value.artifacts) || value.artifacts.length !== 3) {
    ...
    for (const [index, expected] of NEG_PATH_BOUNDED_FINITE_ANGLES_ARTIFACT_SPECS_V1.entries()) {
  ...
  return deepFreezeOwned({
    ok: true as const,
    value: value as unknown as NegPathBoundedFiniteAnglesCandidateBundleLedgerV1,
  });
}
...
export function boundedFiniteAnglesJsonDifferencePaths(
  left: unknown,
  right: unknown,
  path = '$',
): string[] {
  ...
  if (Array.isArray(left) && Array.isArray(right)) {
    ...
    for (let index = 0; index < Math.max(left.length, right.length); index += 1) {
      ...
      if (!Object.hasOwn(left, index) || !Object.hasOwn(right, index)) differences.push(childPath);
        ...
        differences.push(
          ...boundedFiniteAnglesJsonDifferencePaths(left[index], right[index], childPath),
        );
    }
    return differences;
  }
  if (isRecord(left) && isRecord(right)) {
    ...
    for (const key of keys) {
      ...
      if (!Object.hasOwn(left, key) || !Object.hasOwn(right, key)) differences.push(childPath);
        ...
        differences.push(
          ...boundedFiniteAnglesJsonDifferencePaths(left[key], right[key], childPath),
        );
    }
    return differences;
  }
...
export type NegPathBoundedFiniteAnglesCandidateBuiltFileV1 = Readonly<{
  artifactId: string | null;
  path: string;
  text: string;
}>;

export type NegPathBoundedFiniteAnglesCandidateBuildV1 = Readonly<{
  ledger: NegPathBoundedFiniteAnglesCandidateBundleLedgerV1;
  files: readonly NegPathBoundedFiniteAnglesCandidateBuiltFileV1[];
}>;

export function buildNegPathBoundedFiniteAnglesCandidateBundleV1(): NegPathBoundedFiniteAnglesCandidateBuildV1 {
  if (!parseArtifactContractV1(NEG_PATH_BOUNDED_FINITE_ANGLES_FOLD_CONTROL_SOURCE_V1).ok) {
    throw new TypeError('accepted finite-angles control no longer parses');
  }
  const differences = boundedFiniteAnglesJsonDifferencePaths(
    NEG_PATH_BOUNDED_FINITE_ANGLES_FOLD_CONTROL_SOURCE_V1,
    NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.sourceDocument,
  );
  if (!sameStableJson(differences, NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.changedPaths)) {
    throw new TypeError('bounded finite-angles delta changed');
  }
  ...
  if (
    ...
    !sameStableJson(
      ...
      NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.expectedIssues,
    )
  ) {
    throw new TypeError('bounded finite-angles parser oracle changed');
  }
  const textByArtifactId = new Map<string, string>([
    ['bundle-readme', NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_README_V1],
    [CONTROL_ARTIFACT_ID, jsonLine(NEG_PATH_BOUNDED_FINITE_ANGLES_FOLD_CONTROL_SOURCE_V1)],
    [SOURCE_ARTIFACT_ID, jsonLine(NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.sourceDocument)],
  ]);
  const artifacts = NEG_PATH_BOUNDED_FINITE_ANGLES_ARTIFACT_SPECS_V1.map((spec) => {
    const text = textByArtifactId.get(spec.artifactId);
    if (text === undefined)
      throw new TypeError(`missing bounded-finite-angles artifact ${spec.artifactId}`);
    return { ...spec, sha256: sha256Prefixed(text) as `sha256:${string}` };
  });
  const ledger: NegPathBoundedFiniteAnglesCandidateBundleLedgerV1 = {
    schemaVersion: 1,
    schemaId: NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCHEMA_ID,
    recordType: NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_RECORD_TYPE,
    contractStatus: 'candidate',
  ...
  const files: NegPathBoundedFiniteAnglesCandidateBuiltFileV1[] = artifacts.map((artifact) => {
    const text = textByArtifactId.get(artifact.artifactId);
    if (text === undefined)
      throw new TypeError(`missing bounded-finite-angles artifact ${artifact.artifactId}`);
    return { artifactId: artifact.artifactId, path: artifact.path, text };
  });
  files.push({
    artifactId: null,
    path: NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    text: jsonLine(ledger),
  });
  return deepFreezeOwned({ ledger, files });
}

export async function writeNegPathBoundedFiniteAnglesCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundedFiniteAnglesCandidateBuildV1> {
  const built = buildNegPathBoundedFiniteAnglesCandidateBundleV1();
  ...
  if (existing.some((entry) => !entry.isFile() || !expectedNames.has(entry.name))) {
    throw new TypeError(
      'negative path bounded-finite-angles candidate directory contains an unexpected entry',
    );
  }
  await Promise.all(
...
export const NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_REASON_CODES = [
  'ledger-unreadable',
  'ledger-invalid',
...
export type NegPathBoundedFiniteAnglesCandidateReasonCodeV1 =
  (typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_REASON_CODES)[number];
...
export type NegPathBoundedFiniteAnglesCandidateVerificationResultV1 = Readonly<{
  schemaVersion: 1;
  recordType: 'm0f-neg-path-bounded-finite-angles-candidate-bundle-verification-result';
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES-V1';
  scope: typeof NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCOPE;
  ...
  reasonCodes: readonly NegPathBoundedFiniteAnglesCandidateReasonCodeV1[];
  checks: VerificationChecks;
}>;

interface MutableVerificationState {
  reasons: Set<NegPathBoundedFiniteAnglesCandidateReasonCodeV1>;
...
): NegPathBoundedFiniteAnglesCandidateVerificationResultV1 {
  const reasonCodes = NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_REASON_CODES.filter((code) =>
    state.reasons.has(code),
  );
  return deepFreezeOwned({
    schemaVersion: 1 as const,
    recordType: 'm0f-neg-path-bounded-finite-angles-candidate-bundle-verification-result' as const,
    contractStatus: 'candidate' as const,
    scientificClaim: false as const,
    vectorSetId: 'NEG-PATH-MUTATION-BOUNDED-FINITE-ANGLES-V1' as const,
    scope: NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_SCOPE,
    declaredBoundedInterpolationFiniteAnglesParserOnly: true as const,
...
async function canonicalCaseIsAbsent(): Promise<boolean | undefined> {
  try {
    const parsed = parseFixtureManifest(
      JSON.parse(
        await readFile(resolve(NEG_PATH_BOUNDED_FINITE_ANGLES_CANONICAL_MANIFEST_PATH), 'utf8'),
      ) as unknown,
    );
    if (parsed.manifest === undefined) return undefined;
    return !parsed.manifest.fixtures.some(
      (fixture) => fixture.id === NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_ID,
    );
  } catch {
    return undefined;
  }
...
export async function verifyNegPathBoundedFiniteAnglesCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundedFiniteAnglesCandidateVerificationResultV1> {
  ...
  try {
    ...
    try {
      ledgerText = await readFile(
        resolve(absoluteDirectory, NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_LEDGER_FILENAME),
        'utf8',
      );
    ...
    const parsedLedger = parseNegPathBoundedFiniteAnglesCandidateBundleLedgerV1(ledgerDocument);
    if (!parsedLedger.ok) {
    ...
    const expectedNames = new Set([
      NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    ...
    const textByPath = new Map<string, string>([
      [NEG_PATH_BOUNDED_FINITE_ANGLES_CANDIDATE_BUNDLE_LEDGER_FILENAME, ledgerText],
    ]);
    ...
    if (source === undefined) {
      ...
      if (
        control !== undefined &&
        sameStableJson(
          boundedFiniteAnglesJsonDifferencePaths(control, source),
          NEG_PATH_BOUNDED_FINITE_ANGLES_CASE_SPEC_V1.changedPaths,
        )
      ) {
    ...
    const regenerated = buildNegPathBoundedFiniteAnglesCandidateBundleV1();
