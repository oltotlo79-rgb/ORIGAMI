...
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID =
  'https://oridesign.local/schemas/m0f/neg-path-bound-knot-interval-cardinality-candidate-bundle-ledger-v1.schema.json' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE =
  'm0f-neg-path-bound-knot-interval-cardinality-candidate-bundle-ledger' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCOPE =
  'project-authored-exact-negative-artifact-contract-bounded-interpolation-bound-knot-interval-cardinality-parser-replay-only' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_ID =
  'oridesign-neg-path-bound-knot-interval-cardinality-candidate-bundle' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_VERSION =
  '1.0.0-candidate' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY =
  'tests/candidate-vectors/NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME =
  'candidate-bundle-ledger.json' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANONICAL_MANIFEST_PATH =
  'tests/fixtures/manifest.json' as const;
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_ID =
  'NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH' as const;

const SOURCE_REFERENCE_ID =
  'oridesign-neg-path-bound-knot-interval-cardinality-candidate-v1' as const;
const CONTROL_ARTIFACT_ID = 'control-fold' as const;
const SOURCE_ARTIFACT_ID = 'source-path-bound-knot-interval-cardinality' as const;
const SHA256_PATTERN = /^sha256:[0-9a-f]{64}$/;

export type NegPathBoundKnotIntervalCardinalitySourceDocumentV1 = NegPathAngleBoundSourceDocumentV1;

export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_FOLD_CONTROL_SOURCE_V1 = deepFreezeOwned(
  structuredClone(NEG_PATH_ANGLE_BOUND_FOLD_CONTROL_SOURCE_V1),
);

function boundKnotIntervalCardinalitySource(): NegPathBoundKnotIntervalCardinalitySourceDocumentV1 {
  const source = structuredClone(NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_FOLD_CONTROL_SOURCE_V1);
  ...
  if (firstBounds === undefined) throw new TypeError('fixed first bound row is missing');
  const removed = firstBounds.bounds.splice(1, 1);
  if (removed[0]?.[0] !== Math.PI / 2 || removed[0][1] !== Math.PI) {
    throw new TypeError('fixed terminal interval bound must equal [pi/2,pi]');
  }
  return source;
}
...
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1 = deepFreezeOwned({
  caseId: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_ID,
  controlArtifactId: CONTROL_ARTIFACT_ID,
  mutationKind: 'delete-terminal-bound-from-three-knot-bounded-interpolation-row',
  changedPaths: ['$.pathCandidate.segments[0].motion.intervalAngleBoundsByCrease[0].bounds[1]'],
  sourceArtifactId: SOURCE_ARTIFACT_ID,
  sourcePath: 'path-bound-knot-interval-cardinality-mismatch.json',
  sourceDocument: boundKnotIntervalCardinalitySource(),
  expectedIssues: [
    {
...
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_README_V1 = `# NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH exact-negative candidate vector
...
export type NegPathBoundKnotIntervalCardinalityArtifactProvenanceV1 = Readonly<{
...
export type NegPathBoundKnotIntervalCardinalityArtifactLedgerEntryV1 = Readonly<{
  artifactId: string;
  ...
  licenseSpdx: 'MIT';
  provenance: NegPathBoundKnotIntervalCardinalityArtifactProvenanceV1;
}>;

function artifactProvenance(
  dependsOnArtifactIds: readonly (typeof CONTROL_ARTIFACT_ID)[],
): NegPathBoundKnotIntervalCardinalityArtifactProvenanceV1 {
  return {
...
type ArtifactSpecV1 = Omit<NegPathBoundKnotIntervalCardinalityArtifactLedgerEntryV1, 'sha256'>;

export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_ARTIFACT_SPECS_V1 = deepFreezeOwned([
  {
  ...
  },
  {
    ...
    path: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.sourcePath,
    mediaType: 'application/json',
    licenseSpdx: 'MIT',
...
export type NegPathBoundKnotIntervalCardinalityCaseLedgerRowV1 = Readonly<{
  caseIndex: 0;
  caseId: typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_ID;
  controlArtifactId: typeof CONTROL_ARTIFACT_ID;
  mutationKind: typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.mutationKind;
...
const GENERATOR = deepFreezeOwned({
  generatorId: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_ID,
  generatorVersion: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_GENERATOR_VERSION,
...
const SOURCE_PROVENANCE = deepFreezeOwned({
  ...
  title:
    'NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH project-authored bounded-interpolation bound/knot-interval cardinality parser vector',
  authors: ['OriDesign contributors'],
  redistribution: 'allowed' as const,
  licenseSpdx: 'MIT' as const,
});

function ledgerCases(): readonly NegPathBoundKnotIntervalCardinalityCaseLedgerRowV1[] {
  return [
    {
      caseIndex: 0,
      caseId: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_ID,
      controlArtifactId: CONTROL_ARTIFACT_ID,
      mutationKind: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.mutationKind,
      changedPaths: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.changedPaths,
      sourceArtifactId: SOURCE_ARTIFACT_ID,
      sourcePath: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.sourcePath,
      expectedOutcome: 'rejected',
      expectedIssues: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.expectedIssues,
    },
  ];
}

export type NegPathBoundKnotIntervalCardinalityCandidateBundleLedgerV1 = Readonly<{
  schemaVersion: 1;
  schemaId: typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID;
  recordType: typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE;
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH-V1';
  scope: typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCOPE;
  declaredBoundedInterpolationBoundKnotIntervalCardinalityParserOnly: true;
  canonicalManifestPath: typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANONICAL_MANIFEST_PATH;
  ...
  cases: readonly NegPathBoundKnotIntervalCardinalityCaseLedgerRowV1[];
  artifacts: readonly NegPathBoundKnotIntervalCardinalityArtifactLedgerEntryV1[];
}>;

export type NegPathBoundKnotIntervalCardinalityCandidateLedgerIssueV1 = Readonly<{
  path: string;
  code:
    | 'invalid-snapshot'
    | 'invalid-object'
...
export type NegPathBoundKnotIntervalCardinalityCandidateLedgerParseResultV1 =
  | Readonly<{ ok: true; value: NegPathBoundKnotIntervalCardinalityCandidateBundleLedgerV1 }>
  | Readonly<{
      ok: false;
      error: readonly NegPathBoundKnotIntervalCardinalityCandidateLedgerIssueV1[];
    }>;
...
const FIXED_LITERALS = [
  ['schemaVersion', 1],
  ['schemaId', NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID],
  ['recordType', NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE],
  ['contractStatus', 'candidate'],
  ['scientificClaim', false],
  ['vectorSetId', 'NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH-V1'],
  ['scope', NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCOPE],
  ['declaredBoundedInterpolationBoundKnotIntervalCardinalityParserOnly', true],
  ['canonicalManifestPath', NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANONICAL_MANIFEST_PATH],
  ['canonicalManifestRegistration', 'not-registered'],
  ['canonicalPromotionClaimed', false],
  ['canonicalPathMutationFamilyComplete', false],
  ['angleKnotCardinalityEstablished', false],
...
function addLedgerIssue(
  issues: NegPathBoundKnotIntervalCardinalityCandidateLedgerIssueV1[],
  path: string,
  code: NegPathBoundKnotIntervalCardinalityCandidateLedgerIssueV1['code'],
  message: string,
): void {
...
export function parseNegPathBoundKnotIntervalCardinalityCandidateBundleLedgerV1(
  supplied: unknown,
): NegPathBoundKnotIntervalCardinalityCandidateLedgerParseResultV1 {
  ...
  const issues: NegPathBoundKnotIntervalCardinalityCandidateLedgerIssueV1[] = [];
  ...
  if (!Array.isArray(value.artifacts) || value.artifacts.length !== 3) {
    ...
    for (const [
      index,
      expected,
    ] of NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_ARTIFACT_SPECS_V1.entries()) {
  ...
  return deepFreezeOwned({
    ok: true as const,
    value: value as unknown as NegPathBoundKnotIntervalCardinalityCandidateBundleLedgerV1,
  });
}
...
export function boundKnotIntervalCardinalityJsonDifferencePaths(
  left: unknown,
  right: unknown,
  path = '$',
): string[] {
  ...
  if (Array.isArray(left) && Array.isArray(right)) {
    ...
    for (let index = 0; index < Math.max(left.length, right.length); index += 1) {
      ...
      if (!Object.hasOwn(left, index) || !Object.hasOwn(right, index)) differences.push(childPath);
        ...
        differences.push(
          ...boundKnotIntervalCardinalityJsonDifferencePaths(left[index], right[index], childPath),
        );
    }
    return differences;
  }
  if (isRecord(left) && isRecord(right)) {
    ...
    for (const key of keys) {
      ...
      if (!Object.hasOwn(left, key) || !Object.hasOwn(right, key)) differences.push(childPath);
        ...
        differences.push(
          ...boundKnotIntervalCardinalityJsonDifferencePaths(left[key], right[key], childPath),
        );
    }
    return differences;
  }
...
export type NegPathBoundKnotIntervalCardinalityCandidateBuiltFileV1 = Readonly<{
  artifactId: string | null;
  path: string;
  text: string;
}>;

export type NegPathBoundKnotIntervalCardinalityCandidateBuildV1 = Readonly<{
  ledger: NegPathBoundKnotIntervalCardinalityCandidateBundleLedgerV1;
  files: readonly NegPathBoundKnotIntervalCardinalityCandidateBuiltFileV1[];
}>;

export function buildNegPathBoundKnotIntervalCardinalityCandidateBundleV1(): NegPathBoundKnotIntervalCardinalityCandidateBuildV1 {
  if (
    !parseArtifactContractV1(NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_FOLD_CONTROL_SOURCE_V1).ok
  ) {
    throw new TypeError('accepted bound/knot-interval cardinality control no longer parses');
  }
  const differences = boundKnotIntervalCardinalityJsonDifferencePaths(
  ...
  if (
    !sameStableJson(differences, NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.changedPaths)
  ) {
    throw new TypeError('bound/knot-interval cardinality control deletion delta changed');
  }
  ...
  if (
    ...
    throw new TypeError('bound/knot-interval cardinality parser oracle changed');
  }
  const textByArtifactId = new Map<string, string>([
    ['bundle-readme', NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_README_V1],
    [
      CONTROL_ARTIFACT_ID,
      jsonLine(NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_FOLD_CONTROL_SOURCE_V1),
    ],
    [
      SOURCE_ARTIFACT_ID,
      jsonLine(NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.sourceDocument),
    ],
  ]);
  const artifacts = NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_ARTIFACT_SPECS_V1.map((spec) => {
    const text = textByArtifactId.get(spec.artifactId);
    if (text === undefined)
      throw new TypeError(`missing bound/knot-interval cardinality artifact ${spec.artifactId}`);
    return { ...spec, sha256: sha256Prefixed(text) as `sha256:${string}` };
  });
  const ledger: NegPathBoundKnotIntervalCardinalityCandidateBundleLedgerV1 = {
    schemaVersion: 1,
    schemaId: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCHEMA_ID,
    recordType: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_RECORD_TYPE,
    contractStatus: 'candidate',
  ...
  const files: NegPathBoundKnotIntervalCardinalityCandidateBuiltFileV1[] = artifacts.map(
    (artifact) => {
      const text = textByArtifactId.get(artifact.artifactId);
      if (text === undefined)
        throw new TypeError(
          `missing bound/knot-interval cardinality artifact ${artifact.artifactId}`,
        );
  ...
  files.push({
    artifactId: null,
    path: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    text: jsonLine(ledger),
  });
  return deepFreezeOwned({ ledger, files });
}

export async function writeNegPathBoundKnotIntervalCardinalityCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundKnotIntervalCardinalityCandidateBuildV1> {
  const built = buildNegPathBoundKnotIntervalCardinalityCandidateBundleV1();
  ...
  if (existing.some((entry) => !entry.isFile() || !expectedNames.has(entry.name))) {
    throw new TypeError(
      'negative path bound/knot-interval cardinality candidate directory contains an unexpected entry',
    );
  }
  await Promise.all(
...
export const NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_REASON_CODES = [
  'ledger-unreadable',
  'ledger-invalid',
...
export type NegPathBoundKnotIntervalCardinalityCandidateReasonCodeV1 =
  (typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_REASON_CODES)[number];
...
export type NegPathBoundKnotIntervalCardinalityCandidateVerificationResultV1 = Readonly<{
  schemaVersion: 1;
  recordType: 'm0f-neg-path-bound-knot-interval-cardinality-candidate-bundle-verification-result';
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH-V1';
  scope: typeof NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCOPE;
  ...
  reasonCodes: readonly NegPathBoundKnotIntervalCardinalityCandidateReasonCodeV1[];
  checks: VerificationChecks;
}>;

interface MutableVerificationState {
  reasons: Set<NegPathBoundKnotIntervalCardinalityCandidateReasonCodeV1>;
...
): NegPathBoundKnotIntervalCardinalityCandidateVerificationResultV1 {
  const reasonCodes = NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_REASON_CODES.filter(
    (code) => state.reasons.has(code),
  );
  return deepFreezeOwned({
    schemaVersion: 1 as const,
    recordType:
      'm0f-neg-path-bound-knot-interval-cardinality-candidate-bundle-verification-result' as const,
    contractStatus: 'candidate' as const,
    scientificClaim: false as const,
    vectorSetId: 'NEG-PATH-MUTATION-BOUND-KNOT-INTERVAL-CARDINALITY-MISMATCH-V1' as const,
    scope: NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_SCOPE,
    declaredBoundedInterpolationBoundKnotIntervalCardinalityParserOnly: true as const,
...
async function canonicalCaseIsAbsent(): Promise<boolean | undefined> {
  try {
    const parsed = parseFixtureManifest(
      JSON.parse(
        await readFile(
          resolve(NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANONICAL_MANIFEST_PATH),
          'utf8',
        ),
      ) as unknown,
    );
    ...
    return !parsed.manifest.fixtures.some(
      (fixture) => fixture.id === NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_ID,
    );
  } catch {
    return undefined;
  }
...
export async function verifyNegPathBoundKnotIntervalCardinalityCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathBoundKnotIntervalCardinalityCandidateVerificationResultV1> {
  ...
  try {
    ...
    const parsedLedger =
      parseNegPathBoundKnotIntervalCardinalityCandidateBundleLedgerV1(ledgerDocument);
    if (!parsedLedger.ok) {
    ...
    const textByPath = new Map<string, string>([
      [NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CANDIDATE_BUNDLE_LEDGER_FILENAME, ledgerText],
    ]);
    ...
    if (source === undefined) {
      ...
      if (
        control !== undefined &&
        sameStableJson(
          boundKnotIntervalCardinalityJsonDifferencePaths(control, source),
          NEG_PATH_BOUND_KNOT_INTERVAL_CARDINALITY_CASE_SPEC_V1.changedPaths,
        )
      ) {
    ...
    const regenerated = buildNegPathBoundKnotIntervalCardinalityCandidateBundleV1();
