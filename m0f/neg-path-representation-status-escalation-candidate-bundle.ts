...
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCHEMA_ID =
  'https://oridesign.local/schemas/m0f/neg-path-representation-status-escalation-candidate-bundle-ledger-v1.schema.json' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_RECORD_TYPE =
  'm0f-neg-path-representation-status-escalation-candidate-bundle-ledger' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCOPE =
  'project-authored-exact-negative-artifact-contract-path-candidate-representation-status-parser-replay-only' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_GENERATOR_ID =
  'oridesign-neg-path-representation-status-escalation-candidate-bundle' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_GENERATOR_VERSION =
  '1.0.0-candidate' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY =
  'tests/candidate-vectors/NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_LEDGER_FILENAME =
  'candidate-bundle-ledger.json' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANONICAL_MANIFEST_PATH =
  'tests/fixtures/manifest.json' as const;
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_ID =
  'NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION' as const;

const SOURCE_REFERENCE_ID =
  'oridesign-neg-path-representation-status-escalation-candidate-v1' as const;
const CONTROL_ARTIFACT_ID = 'control-fold' as const;
const SOURCE_ARTIFACT_ID = 'source-path-representation-status-escalation' as const;
const SHA256_PATTERN = /^sha256:[0-9a-f]{64}$/;

export type NegPathRepresentationStatusEscalationSourceDocumentV1 =
  NegPathAngleBoundSourceDocumentV1;

function ownedAcceptedControl(): NegPathRepresentationStatusEscalationSourceDocumentV1 {
...
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_FOLD_CONTROL_SOURCE_V1 =
  deepFreezeOwned(ownedAcceptedControl());

function representationStatusEscalationSource(): NegPathRepresentationStatusEscalationSourceDocumentV1 {
  const source = structuredClone(NEG_PATH_REPRESENTATION_STATUS_ESCALATION_FOLD_CONTROL_SOURCE_V1);
  const pathCandidate = source.pathCandidate as unknown as Record<string, unknown>;
  if (pathCandidate.representationStatus !== 'candidate') {
    throw new TypeError('fixed path candidate status must remain candidate before escalation');
  }
  pathCandidate.representationStatus = 'verified';
  return source;
}

type ExpectedIssueV1 = Readonly<{ path: string; code: string }>;

export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1 = deepFreezeOwned({
  caseId: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_ID,
  controlArtifactId: CONTROL_ARTIFACT_ID,
  mutationKind: 'escalate-path-candidate-representation-status',
  changedPaths: ['$.pathCandidate.representationStatus'],
  sourceArtifactId: SOURCE_ARTIFACT_ID,
  sourcePath: 'path-representation-status-escalation.json',
  sourceDocument: representationStatusEscalationSource(),
  expectedIssues: [
    {
...
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_README_V1 = `# NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION exact-negative candidate vector
...
export type NegPathRepresentationStatusEscalationArtifactProvenanceV1 = Readonly<{
...
export type NegPathRepresentationStatusEscalationArtifactLedgerEntryV1 = Readonly<{
  artifactId: string;
  ...
  licenseSpdx: 'MIT';
  provenance: NegPathRepresentationStatusEscalationArtifactProvenanceV1;
}>;

function artifactProvenance(
  dependsOnArtifactIds: readonly (typeof CONTROL_ARTIFACT_ID)[],
): NegPathRepresentationStatusEscalationArtifactProvenanceV1 {
  return {
...
type ArtifactSpecV1 = Omit<NegPathRepresentationStatusEscalationArtifactLedgerEntryV1, 'sha256'>;

export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_ARTIFACT_SPECS_V1 = deepFreezeOwned([
  {
  ...
  },
  {
    ...
    path: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.sourcePath,
    mediaType: 'application/json',
    licenseSpdx: 'MIT',
...
export type NegPathRepresentationStatusEscalationCaseLedgerRowV1 = Readonly<{
  caseIndex: 0;
  caseId: typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_ID;
  controlArtifactId: typeof CONTROL_ARTIFACT_ID;
  mutationKind: typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.mutationKind;
  changedPaths: readonly ['$.pathCandidate.representationStatus'];
...
const GENERATOR = deepFreezeOwned({
  generatorId: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_GENERATOR_ID,
  generatorVersion: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_GENERATOR_VERSION,
...
const SOURCE_PROVENANCE = deepFreezeOwned({
  ...
  title:
    'NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION project-authored path-candidate representation-status parser vector',
  authors: ['OriDesign contributors'],
  redistribution: 'allowed' as const,
  licenseSpdx: 'MIT' as const,
});

function ledgerCases(): readonly NegPathRepresentationStatusEscalationCaseLedgerRowV1[] {
  return [
    {
      caseIndex: 0,
      caseId: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_ID,
      controlArtifactId: CONTROL_ARTIFACT_ID,
      mutationKind: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.mutationKind,
      changedPaths: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.changedPaths,
      sourceArtifactId: SOURCE_ARTIFACT_ID,
      sourcePath: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.sourcePath,
      expectedOutcome: 'rejected',
      expectedIssues: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.expectedIssues,
    },
  ];
}

export type NegPathRepresentationStatusEscalationCandidateBundleLedgerV1 = Readonly<{
  schemaVersion: 1;
  schemaId: typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCHEMA_ID;
  recordType: typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_RECORD_TYPE;
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION-V1';
  scope: typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCOPE;
  ...
  canonicalManifestPath: typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANONICAL_MANIFEST_PATH;
  ...
  cases: readonly NegPathRepresentationStatusEscalationCaseLedgerRowV1[];
  artifacts: readonly NegPathRepresentationStatusEscalationArtifactLedgerEntryV1[];
}>;

export type NegPathRepresentationStatusEscalationCandidateLedgerIssueV1 = Readonly<{
  path: string;
  code:
    | 'invalid-snapshot'
    | 'invalid-object'
...
export type NegPathRepresentationStatusEscalationCandidateLedgerParseResultV1 =
  | Readonly<{ ok: true; value: NegPathRepresentationStatusEscalationCandidateBundleLedgerV1 }>
  | Readonly<{
      ok: false;
      error: readonly NegPathRepresentationStatusEscalationCandidateLedgerIssueV1[];
    }>;
...
const FIXED_LITERALS = [
  ['schemaVersion', 1],
  ['schemaId', NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCHEMA_ID],
  ['recordType', NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_RECORD_TYPE],
  ['contractStatus', 'candidate'],
  ['scientificClaim', false],
  ['vectorSetId', 'NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION-V1'],
  ['scope', NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCOPE],
  ['declaredPathCandidateRepresentationStatusParserOnly', true],
  ['declaredBoundedInterpolationUniqueAngleCreaseRowsParserOnly', false],
  ['declaredBoundedInterpolationUniqueIntervalBoundCreaseRowsParserOnly', false],
  ['declaredBoundedInterpolationAngleKnotCardinalityParserOnly', false],
  ...
  ['declaredBoundedInterpolationAngleContainmentParserOnly', false],
  ['declaredBoundedInterpolationKnotTimeStrictMonotonicityParserOnly', false],
  ['canonicalManifestPath', NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANONICAL_MANIFEST_PATH],
  ['canonicalManifestRegistration', 'not-registered'],
  ['canonicalPromotionClaimed', false],
  ['canonicalPathMutationFamilyComplete', false],
  ['representationSelectionEstablished', false],
...
function addLedgerIssue(
  issues: NegPathRepresentationStatusEscalationCandidateLedgerIssueV1[],
  path: string,
  code: NegPathRepresentationStatusEscalationCandidateLedgerIssueV1['code'],
  message: string,
): void {
...
export function parseNegPathRepresentationStatusEscalationCandidateBundleLedgerV1(
  supplied: unknown,
): NegPathRepresentationStatusEscalationCandidateLedgerParseResultV1 {
  ...
  const issues: NegPathRepresentationStatusEscalationCandidateLedgerIssueV1[] = [];
  ...
  if (!Array.isArray(value.cases) || value.cases.length !== 1) {
    ...
    addLedgerIssue(
      ...
      '$.cases[0]',
      'invalid-case',
      'case identity, control link, representation-status delta, path, or complete issue oracle differs',
    );
  }
  if (!Array.isArray(value.artifacts) || value.artifacts.length !== 3) {
    ...
    for (const [
      index,
      expected,
    ] of NEG_PATH_REPRESENTATION_STATUS_ESCALATION_ARTIFACT_SPECS_V1.entries()) {
  ...
  return deepFreezeOwned({
    ok: true as const,
    value: value as unknown as NegPathRepresentationStatusEscalationCandidateBundleLedgerV1,
  });
}
...
export function representationStatusEscalationJsonDifferencePaths(
  left: unknown,
  right: unknown,
  path = '$',
): string[] {
  ...
  if (isRecord(left) && isRecord(right)) {
    ...
    for (const key of keys) {
      ...
      if (!Object.hasOwn(left, key) || !Object.hasOwn(right, key)) differences.push(childPath);
        ...
        differences.push(
          ...representationStatusEscalationJsonDifferencePaths(left[key], right[key], childPath),
        );
    }
    return differences;
  }
...
export type NegPathRepresentationStatusEscalationCandidateBuiltFileV1 = Readonly<{
  artifactId: string | null;
  path: string;
  text: string;
}>;

export type NegPathRepresentationStatusEscalationCandidateBuildV1 = Readonly<{
  ledger: NegPathRepresentationStatusEscalationCandidateBundleLedgerV1;
  files: readonly NegPathRepresentationStatusEscalationCandidateBuiltFileV1[];
}>;

export function buildNegPathRepresentationStatusEscalationCandidateBundleV1(): NegPathRepresentationStatusEscalationCandidateBuildV1 {
  if (
    !parseArtifactContractV1(NEG_PATH_REPRESENTATION_STATUS_ESCALATION_FOLD_CONTROL_SOURCE_V1).ok
  ) {
    throw new TypeError('accepted representation-status control no longer parses');
  }
  const differences = representationStatusEscalationJsonDifferencePaths(
  ...
  if (
    !sameStableJson(
      differences,
      NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.changedPaths,
    )
  ) {
    throw new TypeError('representation-status escalation delta changed');
  }
  ...
  if (
    ...
    throw new TypeError('representation-status parser oracle changed');
  }
  const textByArtifactId = new Map<string, string>([
    ['bundle-readme', NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_README_V1],
    [
      CONTROL_ARTIFACT_ID,
      jsonLine(NEG_PATH_REPRESENTATION_STATUS_ESCALATION_FOLD_CONTROL_SOURCE_V1),
    ],
    [
      SOURCE_ARTIFACT_ID,
      jsonLine(NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.sourceDocument),
    ],
  ]);
  const artifacts = NEG_PATH_REPRESENTATION_STATUS_ESCALATION_ARTIFACT_SPECS_V1.map((spec) => {
    const text = textByArtifactId.get(spec.artifactId);
    if (text === undefined)
      throw new TypeError(`missing representation-status artifact ${spec.artifactId}`);
    return { ...spec, sha256: sha256Prefixed(text) as `sha256:${string}` };
  });
  const ledger: NegPathRepresentationStatusEscalationCandidateBundleLedgerV1 = {
    schemaVersion: 1,
    schemaId: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCHEMA_ID,
    recordType: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_RECORD_TYPE,
    contractStatus: 'candidate',
  ...
  const files: NegPathRepresentationStatusEscalationCandidateBuiltFileV1[] = artifacts.map(
    (artifact) => {
      const text = textByArtifactId.get(artifact.artifactId);
      if (text === undefined)
        throw new TypeError(`missing representation-status artifact ${artifact.artifactId}`);
      return { artifactId: artifact.artifactId, path: artifact.path, text };
    },
  );
  files.push({
    artifactId: null,
    path: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_LEDGER_FILENAME,
    text: jsonLine(ledger),
  });
  return deepFreezeOwned({ ledger, files });
}

export async function writeNegPathRepresentationStatusEscalationCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathRepresentationStatusEscalationCandidateBuildV1> {
  const built = buildNegPathRepresentationStatusEscalationCandidateBundleV1();
  ...
  if (existing.some((entry) => !entry.isFile() || !expectedNames.has(entry.name))) {
    throw new TypeError(
      'negative path representation-status candidate directory contains an unexpected entry',
    );
  }
  await Promise.all(
...
export const NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_REASON_CODES = [
  'ledger-unreadable',
  'ledger-invalid',
...
export type NegPathRepresentationStatusEscalationCandidateReasonCodeV1 =
  (typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_REASON_CODES)[number];
...
export type NegPathRepresentationStatusEscalationCandidateVerificationResultV1 = Readonly<{
  schemaVersion: 1;
  recordType: 'm0f-neg-path-representation-status-escalation-candidate-bundle-verification-result';
  contractStatus: 'candidate';
  scientificClaim: false;
  vectorSetId: 'NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION-V1';
  scope: typeof NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCOPE;
  ...
  reasonCodes: readonly NegPathRepresentationStatusEscalationCandidateReasonCodeV1[];
  checks: VerificationChecks;
}>;

interface MutableVerificationState {
  reasons: Set<NegPathRepresentationStatusEscalationCandidateReasonCodeV1>;
...
): NegPathRepresentationStatusEscalationCandidateVerificationResultV1 {
  const reasonCodes = NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_REASON_CODES.filter(
    (code) => state.reasons.has(code),
  );
  return deepFreezeOwned({
    schemaVersion: 1 as const,
    recordType:
      'm0f-neg-path-representation-status-escalation-candidate-bundle-verification-result' as const,
    contractStatus: 'candidate' as const,
    scientificClaim: false as const,
    vectorSetId: 'NEG-PATH-MUTATION-REPRESENTATION-STATUS-ESCALATION-V1' as const,
    scope: NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_SCOPE,
    declaredPathCandidateRepresentationStatusParserOnly: true as const,
...
async function canonicalCaseIsAbsent(): Promise<boolean | undefined> {
  try {
    const parsed = parseFixtureManifest(
      JSON.parse(
        await readFile(
          resolve(NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANONICAL_MANIFEST_PATH),
          'utf8',
        ),
      ) as unknown,
    );
    ...
    return !parsed.manifest.fixtures.some(
      (fixture) => fixture.id === NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_ID,
    );
  } catch {
    return undefined;
  }
...
export async function verifyNegPathRepresentationStatusEscalationCandidateBundleV1(
  bundleDirectory: string = NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_DEFAULT_DIRECTORY,
): Promise<NegPathRepresentationStatusEscalationCandidateVerificationResultV1> {
  ...
  try {
    ...
    const parsedLedger =
      parseNegPathRepresentationStatusEscalationCandidateBundleLedgerV1(ledgerDocument);
    if (!parsedLedger.ok) {
    ...
    const textByPath = new Map<string, string>([
      [NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CANDIDATE_BUNDLE_LEDGER_FILENAME, ledgerText],
    ]);
    ...
    if (source === undefined) {
      ...
      if (
        control !== undefined &&
        sameStableJson(
          representationStatusEscalationJsonDifferencePaths(control, source),
          NEG_PATH_REPRESENTATION_STATUS_ESCALATION_CASE_SPEC_V1.changedPaths,
        )
      ) {
    ...
    const regenerated = buildNegPathRepresentationStatusEscalationCandidateBundleV1();
